...
<table border="0" cellspacing="1" width="95%">
   <tr height="50">
     <td colspan="7"><p align="center" class="style1"><b>Rela&ccedil;&atilde;o de Dep&oacute;sitos</b></p></td>
   </tr>
...
?>
  <tr height="25px" class="fundoTabela">
    <td colspan=7 class="style1" align="left"><b>Rela&ccedil;&atilde;o de dep&oacute;sitos do per&iacute;odo: </b><?php print("$dia2/$mes2/$ano2"); ?> &agrave; <?php print("$dia3/$mes3/$ano3"); ?></td>
  </tr>
   <tr height="25px" class="fundoTabela">
      <td colspan="7" class="style1"><b>Banco:</b> <? echo($bancos); ?></td>
    </tr>
    <tr height="25px" class="fundoTabela">
    	<td colspan="7" class="style1"><b>Status:</b> <? echo($cobranca); ?> <? echo($co_cat); ?></td>
    </tr>
  <tr>
...
<?php 
	...
	*/
	...
	co_imovel=cod and c_cod=co_cliente and (co_data>='$ano2-$mes2-$dia2' AND 
	co_data<='$ano3-$mes3-$dia3') and c_banco like '$not0[c_banco]' and (finalidade='9' OR finalidade='10' OR finalidade='11' OR finalidade='12' OR finalidade='13' OR finalidade='14' OR finalidade='15' OR finalidade='16' OR finalidade='17') and co_impressao='1' and contas.cod_imobiliaria='".$_SESSION['cod_imobiliaria']."' 
...
/*				
                ...
                $codlocacao = $not0[co_locacao];
             	$qry_loca = "select * from locacao where l_cod='$codlocacao' and cod_imobiliaria='".$_SESSION['cod_imobiliaria']."'";
             	$res_loca = mysql_query($qry_loca);
             	while($not_loca = mysql_fetch_array($res_loca))
            	{
            	   $codinquilino = $not_loca[l_cliente];
             	}
            	$qry_inquilino = "select * from clientes where c_cod='$codinquilino' and cod_imobiliaria='".$_SESSION['cod_imobiliaria']."'";
...
*/
            	...
            	{
            	   $nomeinquilino = $not_inquilino['c_nome'];
                   $fone_inquilino = $not_inquilino['c_tel'];
                   $cel_inquilino = $not_inquilino['c_cel'];
                   $email_inquilino = $not_inquilino['c_email'];
                   $fone2_inquilino = $not_inquilino['c_tel2'];
                   $cel2_inquilino = $not_inquilino['c_cel2'];
                   $email2_inquilino = $not_inquilino['c_email_com'];
             	}				
...
?>
  <tr height="25px" class="<?php echo $fundo; ?>">
    <td width="12%" align="left" class="<?php if($not0[co_status] == "ok"){ echo "style17"; }else{ echo "style1"; } ?>"><a href="p_edit_imoveis.php?cod=<?php print("$cod"); ?>&edit=editar" target="_blank" class="<?php if($not0[co_status] == "ok"){ echo "style17"; }else{ echo "style1"; } ?>"><b><?php print("$data"); ?></b></a></td>
    <td width="11%" align="left" class="<?php if($not0[co_status] == "ok"){ echo "style17"; }else{ echo "style1"; } ?>">Ref.: <a href="p_edit_imoveis.php?cod=<?php print("$cod"); ?>&edit=editar" target="_blank" class="<?php if($not0[co_status] == "ok"){ echo "style17"; }else{ echo "style1"; } ?>"><b><?php print("$ref"); ?></b></a></td>
<!--
    <td width="41%" align="left" class="<?php if($not0[co_status] == "ok"){ echo "style17"; }else{ echo "style1"; } ?>">Prop.: <a href="p_clientes.php?c_cod=<?php print("$c_cod"); ?>&lista=1" target="_blank" class="<?php if($not0[co_status] == "ok"){ echo "style17"; }else{ echo "style1"; } ?>"><b><?php print("$cliente"); ?></b></a></td>
-->
    <td width="41%" align="left" class="<?php if($not0[co_status] == "ok"){ echo "style17"; }else{ echo "style1"; } ?>">Prop.: <a href="p_clientes.php?c_cod=<?php print("$c_cod"); ?>&lista=1" target="_blank" class="<?php if($not0[co_status] == "ok"){ echo "style17"; }else{ echo "style1"; } ?>"><b><?php print("$nomeprop"); ?></b></a></td>
    <td width="10%" align="left" class="<?php if($not0[co_status] == "ok"){ echo "style17"; }else{ echo "style1"; } ?>">Valor: <b><span class="<?php if($not0[co_status] == "ok"){ echo "style17"; }else{ echo "style1"; } ?>">R$</a></b></td>
    <td width="9%" align="left" class="<?php if($not0[co_status] == "ok"){ echo "style17"; }else{ echo "style1"; } ?>"><b><?php print("$valor_tela"); ?></b></td>
    <td width="12%" align="left" class="<?php if($not0[co_status] == "ok"){ echo "style17"; }else{ echo "style1"; } ?>"><span class="style1">
    ...
    <td width="5%" align="left" class="<?php if($not0[co_status] == "ok"){ echo "style17"; }else{ echo "style1"; } ?>"><?php
...
?></td>
  ...
  <tr height="25px" class="<?php echo $fundo; ?>">
    <td colspan=6 align="left" class="<?php if($not0[co_status] == "ok"){ echo "style17"; }else{ echo "style1"; } ?>">Conta: <b><?php print("$c_conta"); ?></b></td>
    <td colspan=2 align="left" class="<?php if($not0[co_status] == "ok"){ echo "style17"; }else{ echo "style1"; } ?>"><?php if($co_cat == "Pagar"){ print("$recebido"); } ?>
        </b></td>
  </tr>
    ...
    <td height="20px" colspan=3 align="left" class="<?php if($not0[co_status] == "ok"){ echo "style17"; }else{ echo "style1"; } ?>">Fones : <b><?php echo $fone_inquilino." - ".$fone2_inquilino ?> </b></td>
    <td height="20px" width="25%" align="left" class="<?php if($not0[co_status] == "ok"){ echo "style17"; }else{ echo "style1"; } ?>">Emails : <b><?php echo $email_inquilino." - ".$email2_inquilino ?> </b></td>
    </tr>
    <?php
    }
    ?>
...
?>
  <tr>
    <td colspan=7 class=style1><br /><br /><b>Total a depositar: </b>R$ <?php print("$total_tela"); ?><br /><br /></td>
  </tr>
  <div class=noprint>	
	<tr>
