...
}else{$sql_opcao = $_GET['b_sql_opcao'];}
?>
...
if (in_array($finalidade, range(1, 7))) {
	...
	//echo "<BR>"."Mostra Query1 => ".$query1."<BR>";
	//echo "Mostra OPCAO => ".$sql_opcao."<BR>";
	//echo "Mostra OPCAO_B => ".$b_sql_opcao."<BR>";
	//echo "Mostra Query2 => ".$query2."<BR>";
	//echo "Mostra FINALIDADE => ".$finalidade;
...
<?
	...
	//echo "<BR>"."Mostra Conteudo QUERY1 => ".$query1."<BR>";
...
<?php
	...
	//echo $query2;
	//echo "<BR>"."Mostra Conteudo QUERY2 => ".$query2."<BR>";
              ...
              <tr>
               ...
               <tr bgcolor="#<?php print("$cor1"); ?>"><td colspan="2" class="style48" align="center">
               			<table width="100%" cellpadding="0" cellspacing="0">
               				<tr>
                  				<td width="10%" class="style1" align="center"><a href="p_lista_ven.php?<?=$b_get ?><?=$c_get ?>&tipo1=<?=$tipo1 ?>&ref=<?=$ref ?>&comp1=<?=$comp1 ?>&comp2=<?=$comp2 ?>&comp4=<?=$comp4 ?>&n_quartos=<?=$n_quartos ?>&valor=<?=$valor ?>&dist_mar1=<?=stripslashes($dist_mar1) ?>&query_finalidade=<?=stripslashes($query_finalidade) ?>&finalidade=<?=$finalidade ?>&query_bairro=<?=$query_bairro ?>&query_caracteristica=<?=$query_caracteristica ?>&query_caracteristica2=<?=$query_caracteristica2 ?>&query_estado=<?=stripslashes($query_estado) ?>&query_cidade=<?=stripslashes($query_cidade) ?>&permuta=<?=$permuta ?>&permuta_txt=<?=$permuta_txt ?>&tipo_logradouro=<?=$tipo_logradouro ?>&end=<?=$end ?>&numero_end=<?=$numero_end ?>&cep=<?=$cep ?>&ordem=<?=$ordem ?>&valor_oferta=<?=$valor_oferta ?>&relacao_bens=<?=$relacao_bens ?>&im_estado=<?=$im_estado ?>&local=<?=$local ?>&b_averbada=<?=$b_averbada ?>&b_sql_opcao=<?=$sql_opcao?>&query_averbada=<?=stripslashes($query_averbada)?>&screen=1" class="style7"><? if ($screen > 1) { ?>| Primeira |<? } ?></a></td>
                  				<td width="10%" class="style1" align="center"><a href="p_lista_ven.php?<?=$b_get ?><?=$c_get ?>&tipo1=<?=$tipo1 ?>&ref=<?=$ref ?>&comp1=<?=$comp1 ?>&comp2=<?=$comp2 ?>&comp4=<?=$comp4 ?>&n_quartos=<?=$n_quartos ?>&valor=<?=$valor ?>&dist_mar1=<?=stripslashes($dist_mar1) ?>&query_finalidade=<?=stripslashes($query_finalidade) ?>&finalidade=<?=$finalidade ?>&query_bairro=<?=$query_bairro ?>&query_caracteristica=<?=$query_caracteristica ?>&query_caracteristica2=<?=$query_caracteristica2 ?>&query_estado=<?=stripslashes($query_estado) ?>&query_cidade=<?=stripslashes($query_cidade) ?>&permuta=<?=$permuta ?>&permuta_txt=<?=$permuta_txt ?>&tipo_logradouro=<?=$tipo_logradouro ?>&end=<?=$end ?>&numero_end=<?=$numero_end ?>&cep=<?=$cep ?>&ordem=<?=$ordem ?>&valor_oferta=<?=$valor_oferta ?>&relacao_bens=<?=$relacao_bens ?>&im_estado=<?=$im_estado ?>&local=<?=$local ?>&b_averbada=<?=$b_averbada ?>&b_sql_opcao=<?=$sql_opcao?>&query_averbada=<?=stripslashes($query_averbada)?>&screen=<?=$screen-1?>" class="style6"><? if ($screen > 1) { ?>| Anterior |<? } ?></a></td>
								...
								?>
                  				...
                  				<td width="10%" class="style1" align="center"><a href="p_lista_ven.php?<?=$b_get ?><?=$c_get ?>&tipo1=<?=$tipo1 ?>&ref=<?=$ref ?>&comp1=<?=$comp1 ?>&comp2=<?=$comp2 ?>&comp4=<?=$comp4 ?>&n_quartos=<?=$n_quartos ?>&valor=<?=$valor ?>&dist_mar1=<?=stripslashes($dist_mar1) ?>&query_finalidade=<?=stripslashes($query_finalidade) ?>&finalidade=<?=$finalidade ?>&query_bairro=<?=$query_bairro ?>&query_caracteristica=<?=$query_caracteristica ?>&query_caracteristica2=<?=$query_caracteristica2 ?>&query_estado=<?=stripslashes($query_estado) ?>&query_cidade=<?=stripslashes($query_cidade) ?>&permuta=<?=$permuta ?>&permuta_txt=<?=$permuta_txt ?>&tipo_logradouro=<?=$tipo_logradouro ?>&end=<?=$end ?>&numero_end=<?=$numero_end ?>&cep=<?=$cep ?>&ordem=<?=$ordem ?>&valor_oferta=<?=$valor_oferta ?>&relacao_bens=<?=$relacao_bens ?>&im_estado=<?=$im_estado ?>&local=<?=$local ?>&b_averbada=<?=$b_averbada ?>&b_sql_opcao=<?=$sql_opcao?>&query_averbada=<?=stripslashes($query_averbada)?>&screen=<?=$screen+1?>" class="style6"><? if ($screen < $paginas) { ?>| Próxima |<?}?></a></td>
                  				<td width="10%" class="style1" align="center"><a href="p_lista_ven.php?<?=$b_get ?><?=$c_get ?>&tipo1=<?=$tipo1 ?>&ref=<?=$ref ?>&comp1=<?=$comp1 ?>&comp2=<?=$comp2 ?>&comp4=<?=$comp4 ?>&n_quartos=<?=$n_quartos ?>&valor=<?=$valor ?>&dist_mar1=<?=stripslashes($dist_mar1) ?>&query_finalidade=<?=stripslashes($query_finalidade) ?>&finalidade=<?=$finalidade ?>&query_bairro=<?=$query_bairro ?>&query_caracteristica=<?=$query_caracteristica ?>&query_caracteristica2=<?=$query_caracteristica2 ?>&query_estado=<?=stripslashes($query_estado) ?>&query_cidade=<?=stripslashes($query_cidade) ?>&permuta=<?=$permuta ?>&permuta_txt=<?=$permuta_txt ?>&tipo_logradouro=<?=$tipo_logradouro ?>&end=<?=$end ?>&numero_end=<?=$numero_end ?>&cep=<?=$cep ?>&ordem=<?=$ordem ?>&valor_oferta=<?=$valor_oferta ?>&relacao_bens=<?=$relacao_bens ?>&im_estado=<?=$im_estado ?>&local=<?=$local ?>&b_averbada=<?=$b_averbada ?>&b_sql_opcao=<?=$sql_opcao?>&query_averbada=<?=stripslashes($query_averbada)?>&screen=<?=$paginas?>" class="style7"><? if ($screen < $paginas) { ?>| Última |<?}?></a></td>
               				</tr>
   						</table>
<?
