...
?>
<tr height="50">
	<td colspan=7 class=style1 align="center"><b>Extrato de Depósitos</b></td>
</tr>
<tr class="fundoTabela">
	<td colspan=7><table width=100%>
		<tr>
			<td class=style1><b>Ref.:</b> <?php print("$ref"); ?></td>
			<td class=style1><b>Imóvel:</b> <?php print("$titulo"); ?></td>
			<td class=style1><b>Prop(s).:</b>
<?
				...
				for($i3 = 1; $i3 <= $contador; $i3++){
						...
						while ($not40 = mysql_fetch_array($result40)) {
                            echo("<a href=\"p_lista_contas.php?co_cliente=".$not40['c_cod']."&nome_cliente=".$not40['c_nome']."&co_status=pendente&status=C\" target=\"_blank\" class=\"style1\">".$not40['c_nome']."</a><br>"); 
						}
				}
...
<tr height="50">
	<td colspan=7 align="center"><a href="javascript:;" onClick="NewWindow('recibo_imobiliaria.php?locacao=<?php print($co_locacao); ?>', 'janelaR', 750, 500, 'yes');" class="style1"><b>Recibo Imobiliária</b></a></td>
</tr>
<?php
	}
?>
...
<tr class="fundoTabela">
	<td colspan=7><table width=100%>
		<tr>
			<td class=style1><?php print("$data_ent"); ?> à <?php print("$data_sai"); ?> - <?php print("$total_vigencia"); ?> meses</td>
...
<tr height="50">
	<td colspan=7 class=style1 align="center"><b>Depósitos à receber do Locatário:</b></td>
</tr>
<?php
	if($total_credp7 != 0){
...
<tr class="fundotabela">
	<td colspan=7><table width=100%>
		<tr>
			<td class=style7 align=center><b>Existe saldo anterior pendente: R$ <?php print("$total_credp_tela7"); ?></b> - <a href="#" onclick="NewWindow('p_extrato_depositos.php?locacao=<?php print("$locacao_ant"); ?>&tipo_pesq=Locação', 'janelaE', 750, 500, 'yes')" class="style1">Visualizar</a></td>
		</tr>
	</table></td>
</tr>
<?php
...
<td align="left" class="<?php if($not2[co_cat] == "Pagar"){ echo "style7"; }else{ echo "style6"; } ?>"><?php if($not2[co_status] == "pendente"){ echo "<b>"; } ?>R$ <input type="text" name="valor" value="<?php print("$not2[co_valor]"); ?>" size="10" class="campo" <?php if($not2[co_status] == "ok"){ echo "readonly"; } ?>></td>
...
<tr class="fundoTabela">
	<td colspan=7><table width=100%>
		<tr>
			...
			<td class=style1 width=50%><b>Valor à Receber:</b> <span class=style7>R$ <?php print("$total_credp_tela"); ?></span></td>
</tr></table></td>
</tr>
<?php
	}
?>
<tr height="50">
	<td colspan=7 class=style1 align="center"><b>Despesas à receber do Proprietário:</b></td>
</tr>
<?php
	if($total_debp70 != 0){
...
<tr class="fundoTabela">
	<td colspan=7><table width=100%>
		<tr>
			<td class=style7 align=center><b>Existe saldo anterior pendente das despesas do imóvel: R$ <?php print("$total_debp_tela70"); ?></b> - <a href="#" onclick="NewWindow('extrato_despesas_imovel.php?codim=<?php print("$cod_imovel"); ?>&buscad=1', 'janelaF', 750, 500, 'yes')" class="style1">Visualizar</a></td>
		</tr>
	</table></td>
</tr>
<?php
...
<tr class="fundoTabela">
	<td colspan=7><table width=100%>
		<tr>
			<td class=style7 align=center><b>Existe saldo anterior pendente: R$ <?php print("$total_cred_desp_tela"); ?></b> - <a href="#" onclick="NewWindow('p_extrato_depositos.php?locacao=<?php print("$locacao_ant"); ?>&tipo_pesq=Locação', 'janelaG', 750, 500, 'yes');" class="style1">Visualizar</a></td>
		</tr>
	</table></td>
</tr>
<?php
...
<input type="hidden" name="co_cat" value="<?php print("$not2[co_cat]"); ?>">
<tr class="<?php echo $fundo; ?>">
<td class="<?php if($not2[co_cat] == "Pagar"){ echo "style6"; }else{ echo "style1"; } ?>" align="left"><?php if($not2[co_status] == "pendente"){ echo "<b>"; } ?><?php print("$not2[co_forma]"); ?></td>
<?php
	//$valor_tela = $not2[co_valor];
?>
<td align="left" class="<?php if($not2[co_cat] == "Pagar"){ echo "style6"; }else{ echo "style1"; } ?>"><?php if($not2[co_status] == "pendente"){ echo "<b>"; } ?>R$ <input type="text" name="valor" value="<?php print("$valor_tela"); ?>" size="10" class="campo" <?php if($not2[co_status] == "ok"){ echo "readonly"; } ?>></td>
<td width=70 align="left" class="<?php if($not2[co_cat] == "Pagar"){ echo "style7"; }else{ echo "style1"; } ?>"></td>
<td align="left" class="<?php if($not2[co_cat] == "Pagar"){ echo "style6"; }else{ echo "style1"; } ?>"><?php if($not2[co_status] == "pendente"){ echo "<b>"; } ?>para</td>
<td align="left" class="<?php if($not2[co_cat] == "Pagar"){ echo "style6"; }else{ echo "style1"; } ?>"><?php if($not2[co_status] == "pendente"){ echo "<b>"; } ?><?php print("$data"); ?> </td>
<td align="left" class="<?php if($not2[co_cat] == "Pagar"){ echo "style6"; }else{ echo "style1"; } ?>"><?php if($not2[co_status] == "pendente"){ echo "<b>"; } ?><?php print("$not2[co_tipo]"); ?></td>
<td align="right" class="<?php if($not2[co_cat] == "Pagar"){ echo "style6"; }else{ echo "style1"; } ?>"><?php if($not2[co_status] == "pendente"){ echo "<b>"; } ?>
<?php
	if($not2[co_status] == "ok"){
?>
<?php print("$data_status - $not2[co_status]"); ?> <input type="submit" value="X" class=campo3 name="acao">
...
<tr class="fundoTabela">
	<td colspan=7><table width=100%>
		<tr>
			<td class=style1 width=50%><b>Valor Recebido:</b> <span class=style6>R$ <?php print("$total_deb_tela"); ?></span></td>
			<td class=style1 width=50%><b>Valor à Receber:</b> <span class=style7>R$ <?php print("$total_debp_tela"); ?></span></td>
</tr></table>
</td>
</tr>
<?php	
...
?>
<tr height="50">
	<td colspan=7 class=style1 align="center"><b>Depósitos à fazer ao Proprietário:</b></td>
</tr>
<?php
	if($total_debp7 != 0){
...
<tr class="fundoTabela">
	<td colspan=7><table width=100%>
		<tr>
			<td class=style7 align=center><b>Existe saldo anterior pendente: R$ <?php print("$total_debp_tela7"); ?></b> - <a href="#" onclick="NewWindow('p_extrato_depositos.php?locacao=<?php print("$locacao_ant"); ?>&tipo_pesq=Locação', 'janelaH', 750, 500, 'yes');" class="style1">Visualizar</a></td>
		</tr>
	</table></td>
</tr>
<?php
...
<tr class="fundoTabela">
	<td colspan=7><table width=100%>
		<tr>
			...
			<td class=style1 width=50%><b>Valor à Pagar:</b> <span class=style7>R$ <?php print("$total_debp_tela"); ?></span></td>
</tr></table>
</td>
</tr>
<?php
