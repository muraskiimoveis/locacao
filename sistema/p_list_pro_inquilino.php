...
<table border="0" cellpadding="1" cellspacing="1" bgcolor="#<?php print("$cor1"); ?>">
	<form method="get" action="p_list_pro_inquilino.php">
		<input type="hidden" value="1" name="list">
      <input type="hidden" value="" name="lista">
      <tr>
		<td bgcolor="#<?=$cor3 ?>" colspan=5 class="style1" align="center"><b>Relação de Clientes</b></td>
	</tr>
     ...
     <tr bgcolor="#<?php print("$cor1"); ?>" align=center>
	      <td colspan=5 class=style1><div align="left"><span class="style7">Se o propriet&aacute;rio n&atilde;o est&aacute; cadastrado <a target="_blank" href="p_insert_clientes.php?novo=S&url=<?=$REQUEST_URI ?>" class="style7">clique aqui</a></span></div></td>
    </tr>
  </form>
<tr>
...
<td bgcolor="#<?php print("$fundo"); ?>" class="style1">
<p align="center">
<input type="button" onClick="window.opener.document.form1.prop_inquilino.value='<?php print("$not[c_nome]"); ?>';window.opener.focus(); window.close();" class="campo3" value="Selecionar"></td>
<!--a href="#" onClick="window.opener.document.form1.prop_inquilino.value='<?php print("$not[c_nome]"); ?>';window.opener.focus(); window.close();" class="style1">Selecionar</a></td-->
<?php
	}
...
?>
  <tr><td colspan=5 bgcolor="#<?php print("$cor3"); ?>" class=style1>
                  ...
                  <tr><td colspan=10 bgcolor="#<?php print("$cor1"); ?>" class=style1>
