...
if($buscad=='1'){
	...
	$query20 = "select m.contador, m.cliente from clientes c, muraski m, contas co where co.co_imovel='$codim' and co.co_imovel=m.cod and m.cod_imobiliaria='".$_SESSION['cod_imobiliaria']."'";
	...
	for($i3 = 1; $i3 <= $contador; $i3++){
	    if($i3==1){  
			$cod_cliente2 .= "c.c_cod='".$cliente2[$i3-1]."'";
		}else{
		  	$cod_cliente2 .= " or c.c_cod='".$cliente2[$i3-1]."'";
		}
	} 
	$cod_cliente2 .= ")"; 
	
	
	$query0 = "select * from clientes c, muraski m, contas co where m.cliente like '".$cod_cliente."' and $cod_cliente2 and co.co_imovel='$codim' and co.co_imovel=m.cod and m.cod_imobiliaria='".$_SESSION['cod_imobiliaria']."'";
