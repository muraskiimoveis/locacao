...
<p align="center"><b>Relatório de Entradas - Locação temporada - Data - <?php echo "De ".$dia_entrada."/".$mes_entrada."/".$ano_entrada." até ".$dia_entrada1."/".$mes_entrada1."/".$ano_entrada1;?></p>
</td></tr>
<?php
