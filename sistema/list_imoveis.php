...
<table width="95%" cellpadding="1" cellspacing="1">
  <form method="get" action="list_imoveis.php" name="form1" id="form1">
  <input type="hidden" value="<?=$id ?>" name="id" id="id">
    <tr height="50">
		<td colspan=5 class="style1" align="center"><b>Relação de Imóveis</b></td>
	</tr>
    <tr class="fundoTabela">
      ...
      <? } ?>
      <select name="campo" class="campo" onChange="form1.action='list_imoveis.php';form1.submit();">
...
<input type="button" onClick="window.opener.document.form1.nome_imovel.value='<?php print("Ref.: $not[ref] - ".strip_tags($titulo).""); ?>'; window.opener.document.form1.co_imovel.value='<?php print("$not[cod]"); ?>'; window.opener.focus(); window.close();" class="campo3" value="Selecionar"></td>
<!--a href="#" onClick="window.opener.document.form1.nome_imovel.value='<?php print("Ref.: $not[ref] - ".strip_tags($titulo).""); ?>'; window.opener.document.form1.co_imovel.value='<?php print("$not[cod]"); ?>'; window.opener.focus(); window.close();" class="style1">Selecionar</a></td-->
</tr>
<?php
	}
	}
...
?>
                  <tr class="fundoTabelaTitulo">
                  	<td colspan="4" align="center" class="style1"><b>Foram encontrados <?php print("$not2[contador]"); ?> imóveis</b></td>
                  </tr>
