      ...
      <td colspan="2"><table width="100%" border="0" cellpadding="1" cellspacing="1">
        ...
        <tr>
           <td aling="center" colspan="6"><form name="form3" id="form3" method="post" action="">
             <div align="center">
               <input type="submit" value="Exportar para PDF" name="exportar" id="exportar" class="campo3" onClick="form3.action='p_rel_contas_receber_pdf.php?data_inicial=<?=$data_inicial ?>&data_final=<?=$data_final ?>&cliente=<?=$cliente ?>&nome_cliente=<?=$nome_cliente ?>&buscar=<?=$buscar ?>';">
             </div>
           </form></td>
        <tr>
  </table>
