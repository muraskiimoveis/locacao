...
<table border="0" cellpadding="1" cellspacing="1" width="95%">
	<form method="get" action="p_list_prop_loc.php">
		<input type="hidden" value="1" name="list">
      <input type="hidden" value="" name="lista">
      <tr height="50">
		<td colspan=5 class="style1" align="center"><b>Relação de Proprietários/Indicadores</b></td>
	</tr>
	    <tr align="center">
    ...
    <tr>
     ...
     <tr align=center>
	      <td colspan=5 class=style1><div align="left"><span class="style7">Se o propriet&aacute;rio/indicador n&atilde;o est&aacute; cadastrado <a href="p_insert_clientes.php?novo=S&url=<?=$REQUEST_URI ?>" class="style7"><b>clique aqui</b></a></span></div></td>
    </tr>
  </form>
<tr class="fundoTabelaTitulo">
<td width="36%" class="style1"><b>Nome</td>
<td width="18%" class="style1"><b>CPF</td>
<td width="16%" class="style1"><b>Telefone</td>
<td width="15%" class="style1"><b>Tipo</td>
...
<td class="style1">
<p align="center">
<input type="button" onClick="window.opener.document.form1.cliente.value='<?php print("$not[c_cod]"); ?>';window.opener.document.form1.nome_cliente.value='<?php print("$not[c_nome]"); ?>';window.opener.focus(); window.close();" class="campo3" value="Selecionar"></td>
<!--a href="#" onClick="window.opener.document.form1.cliente.value='<?php print("$not[c_cod]"); ?>';window.opener.document.form1.nome_cliente.value='<?php print("$not[c_nome]"); ?>';window.opener.focus(); window.close();" class="style1">Selecionar</a></td-->
<?php
	}
...
?>
  <tr><td colspan=5 class="fundoTabelaTitulo style1">
                  <p align="center">
                  <b>Foram encontrados <?php print("$not2[contador]"); ?> clientes/indicadores</b></td></tr>
