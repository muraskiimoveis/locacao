...
?>
    ...
    <tr bgcolor="#EDEEEE">
      ...
      <td width="70%" class="style1"><input type="text" name="end" size="40" class="campo" value="<?=$end; ?>"></td>
    </tr>
    <tr bgcolor="#EDEEEE">
...
?>
    ...
    <tr bgcolor="#EDEEEE">
      <td class=style1><b>Caracter&iacute;stica:</b></td>
      <td class="style1"><table width="100%" border="0" cellspacing="1" cellpadding="1">
        <tr>
          <?
