...
<td bgcolor="#<?php print("$fundo"); ?>" class="style1">
<p align="center">
<input type="button" onClick="window.opener.document.formulario.testemunha.value='<?php print("$not[c_cod]"); ?>';window.opener.document.formulario.nome_testemunha.value='<?php print("$not[c_nome]"); ?>';window.opener.focus(); window.close();" class="campo3" value="Selecionar"></td>
<!--a href="#" onClick="window.opener.document.formulario.testemunha.value='<?php print("$not[c_cod]"); ?>';window.opener.document.formulario.nome_testemunha.value='<?php print("$not[c_nome]"); ?>';window.opener.focus(); window.close();" class="style1">Selecionar</a></td-->
<?php
	}
