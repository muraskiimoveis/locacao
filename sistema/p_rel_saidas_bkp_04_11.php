...
<td width=71 class="style1"><b>Entrada</td>
<td width=495 class="style1"><b>Imóvel</td>
<td width=95 class="style1"><b>Saída</td>
</tr>
<?php
	$i = 0;
...
<td bgcolor="#<?php print("$fundo2"); ?>" class="style1"><p align="left">
...
?>
<?php print("<b>Ref.:</b> $referencia - <b>Proprietário(s):</b> $proprietarios"); ?>
<?php
    }
/*
	}
...
*/
?>
<?php //print("<b>Ref.: $not3[ref]</b>"); ?>  <?php //print "<b>".strip_tags($not3[1]).$not3[2]."</b>"; ?>
<?php
	//}
?>
<?php
