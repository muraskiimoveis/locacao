...
<div align="center">
  <center>
  <form method="get" action="p_lista_loc.php" name="form1" onSubmit="return valida();">
  <table border="0" cellspacing="1" width="700" bgcolor="#<?php print("$cor1"); ?>">
    <tr bgcolor="#<?php print("$cor1"); ?>">
      <td width="100%" colspan=2 align="center" class=style1><b>Imóveis p/ Locação temporada</b><br>
...
?>
    ...
    <tr bgcolor="#EDEEEE">
      ...
      <td width="70%" class=style1> <select name="finalidade" class="campo">
		...
		$bfinalidade = mysql_query("select f_cod, f_nome FROM finalidade WHERE f_nome LIKE 'Locação_Diária%' ORDER BY f_cod ASC");
