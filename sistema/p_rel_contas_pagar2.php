...
$arquivo = "contas_pagar_".$data_hora.".doc";
...
/*
$html3 .='<link href="style.css" rel="stylesheet" type="text/css" />
<link href="css/estilo.css" rel="stylesheet" type="text/css">';
*/

$html3 .='<table width="750" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td colspan="2" class="style1"><div align="center"><b>Relat&oacute;rio Contas a Pagar </b></div></td>
    </tr>';
...
$html3 .= '<tr>
    ...
    <tr>
      ...
      </b><b>Propriet&aacute;rio:</b>'.$nome_cliente.'</td>
    </tr> 
    <tr>
...
/*
$data_hora3 = date("d_m_Y_H_i_s");
$arquivo3 = "contas_pagar_".$data_hora3.".pdf";
...
<form id="form1" name="form1" method="post" action="">
  <table width="750" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td colspan="2" class="style1"><div align="center"><b>Relat&oacute;rio Contas a Pagar </b><br />
    ...
    <tr>
      <td class="style1"><b>Propriet&aacute;rio:</b>
    ...
    <tr>
      ...
      </b><b> Propriet&aacute;rio:</b> <? if(!empty($_POST['nome_cliente'])){ echo $_POST['nome_cliente']; }else{  echo "Todos"; } ?></td>
    </tr>
      ...
      <td colspan="2"><table width="100%" border="0" cellpadding="1" cellspacing="1">
        ...
        <tr>
           <td aling="center" colspan="6"><form name="form3" id="form3" method="post" action="">
             <div align="center">
               <input type="submit" value="Exportar para DOC" name="exportar" id="exportar" class="campo3" onClick="form3.action='p_rel_contas_pagar.php?pdf=1&data_inicial=<?=$data_inicial ?>&data_final=<?=$data_final ?>&cliente=<?=$cliente ?>&nome_cliente=<?=$nome_cliente ?>&buscar=<?=$buscar ?>';">
             </div>
           </form></td>
        <tr>
  </table>
