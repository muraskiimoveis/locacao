...
<!--
    ...
    Chave gerada pelo Igor Visionnaire = key=AIzaSyBLtW8gKveGtfB3Dnn915JK3VVUdI5DtiM
    Chave gerada por mim key=AIzaSyCy6OIuoEBA30sbs_qwzFJq3z6sjgMxlwE


    <script src="http://maps.google.com/maps?file=api&v=2.x&key=AIzaSyCy6OIuoEBA30sbs_qwzFJq3z6sjgMxlwE"
      type="text/javascript"></script>

    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBLtW8gKveGtfB3Dnn915JK3VVUdI5DtiM&callback=load"
      async defer></script>
-->      
   <script src="http://maps.google.com/maps?file=api&v=2.x&key=AIzaSyBLtW8gKveGtfB3Dnn915JK3VVUdI5DtiM"
      type="text/javascript"></script>
<!--
  <script src="http://maps.googleapis.com/maps/api/js?key=AIzaSyBLtW8gKveGtfB3Dnn915JK3VVUdI5DtiM"
-->
      async defer></script>
