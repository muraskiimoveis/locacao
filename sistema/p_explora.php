...
?>
<?php
$fp = fopen ("/home/httpd/htdocs/img_not/dados.php","w");
...
fwrite($fp,$conteudo);
	...
	$conteudo = "cli|" . $not2[c_cod] . "|" . $c_nome . "|". $not2[c_cpf] 
...
fwrite($fp,$conteudo);
	...
	$conteudo = "int|" . $not3[i_cod] . "|" . $i_nome . "|" . $i_tel . "|" 
...
fwrite($fp,$conteudo);
	...
	{
	$conteudo = "loc|" . $not4[l_cliente] . "|" . $not4[l_imovel] . "|" 
...
fwrite($fp,$conteudo);
	...
	{
	$conteudo = "usu|" . $not5[u_cod] . "|" . $not5[u_nome] . "|" 
...
fwrite($fp,$conteudo);
	...
	{
	$conteudo = "car|" . $not6[ca_usu] . "|" . $not6[ca_imovel] . "|" 
	. $not6[ca_data] . "|" . "\n";
