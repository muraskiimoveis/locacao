...
function valida()
{
  ...
  if (document.form1.cont.selectedIndex == 0 && document.form1.contador.selectedIndex == 0)
  {
        ...
        {
            if (inputs[i].value == ''){
                alert('Por favor, preencha todos os proprietários e percentual selecionados');
                inputs[i].focus();
                return false;
            }
        }  
...
<p align="center" class=style1><b>Editar ou Apagar Imóvel</b></p></td></tr>
    ...
    <tr bgcolor="#EDEEEE">
      <td width="35%" class=style1><b>Proprietário: N° de campos: <select name="cont" id="cont" class="campo" onChange="form1.action='p_edit_imoveis.php?cod=<?php echo($cod); ?>&edit=editar&m=1';form1.submit();">
			...
			if($_POST['cont']){
		     ...
		     for($i3 = 1; $i3 <= $contador; $i3++){
			   ...
			   echo(" 			   		
           			...
           			<b>Percentual:</b>
					<input type=\"text\" name=\"percentual_$i3\" id=\"percentual_$i3\" size=\"2\" class=\"campo\" value=\"".$percentual2[$i3-1]."\">%<a href=\"p_edit_imoveis.php?cod=".$cod."&edit=editar&contador=".$contador."&cont=".$cont."\" class=\"style1\"> Remover</a><br><b>Dados do Prop.: </b><a href=\"p_clientes.php?lista=1&c_cod=".$cliente2[$i3-1]."\" class=\"style1\">Clique aqui para visualizar os dados do cliente</a><br>
			   ");
			 }
		   ...
		   if($cont){
		     for($i = 1; $i <= $cont; $i++){
			   echo("
           			...
           			<b>Percentual:</b>
					<input type=\"text\" name=\"percentual4_$i\" id=\"percentual4_$i\" size=\"2\" class=\"campo\" value=\"".$cliente4."\">%<br>
			   ");
			 }  
		   }
?>         
...
?>
    <tr bgcolor="#EDEEEE">
     ...
     <tr bgcolor="#EDEEEE">
      ...
      <input type="text" name="ende" id="ende" size="50" class="campo" value="<?php print("$not2[end]"); ?>">
      <br>
      <span class="style7">Para que o mapa funcione corretamente sem precisar preencher as coordenadas do Google Maps no campo "Coordenadas" é preciso o tipo de logradouro + endereço completo  e o campo n&uacute;mero preenchidos  (Exemplo: Avenida 29 de Abril 601)</span></td>
    </tr>
     <tr bgcolor="#EDEEEE">
     ...
     <tr bgcolor="#EDEEEE">
       ...
       <td class=style1><input name="cep" type="text" class="campo" id="cep" value="<?php print("$not2[cep]"); ?>" size="8" maxlength="8">
         Exemplo: 80000000 </td>
     </tr>
    <tr bgcolor="#EDEEEE">
...
?>    
	<tr bgcolor="#EDEEEE">
	  ...
	  <select name="local" id="local" class="campo" onChange="form1.action='p_edit_imoveis.php?cod=<?php echo($cod); ?>&edit=editar&m=1';form1.acaoba.value='1';form1.submit();">
<? if($_POST['local']){ ?>  
           	<?=$selecionar2 ?>            
