...
<input type="hidden" name="pastai" id="pastai" value="<?=$pastai; ?>">
  <table width="750" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td colspan="2" class="style1"><div align="center"><b>Amostragem para Avalia&ccedil;&atilde;o </b><br />
      </div></td>
    </tr>
<? if($codi_imo==''){ ?>
    <tr>
    ...
    <tr>
      <td colspan="2"><div align="center"><span class="style1">
        ...
        <input type="button" value="Avaliar" name="avaliar" id="avaliar" class="campo3" onClick="VerificaCampo();">
      </span></div></td>
    </tr>
<? } ?>
    <tr>
      <td colspan="2"><a href="javascript:;" onClick="MM_openBrWindow('p_insert_imoveis_avaliacao.php','','scrollbars=yes,resizable=no,width=800,height=600')" class="style1">Inserir novo imóvel para essa avaliação</a></td>
    </tr>
    <tr>
...
if($co_imovel<>''){
		...
		while($linha3 = mysql_fetch_array($buscaIA)){
		  ...
		  $resultado = $totalmeP * $linha3['metragem'];
			...
			echo("		  
      				...
      				<td width=\"608\" class=\"style1\">".$linha3['titulo']."<br><br>".$linha3['descricao']."</td>
			   </tr>
			   <tr>
			   ...
			   <tr>
    			...
    			<tr>
                  ...
                  <form name=\"form3\" id=\"form3\" method=\"post\" action=\"avaliacao_pdf.php\"><input type=\"submit\" value=\"Exportar para PDF\" name=\"exportar\" id=\"exportar\" class=\"campo3\" onClick=\"form3.action='avaliacao_pdf.php?co_imovel=".$co_imovel."&totalme=".$totalme."&totalmeP=".$totalmeP."';\"></form>
	  				</span></div></td>
    			</tr>
			");
   	 	}
		...
		while($linha = mysql_fetch_array($buscaIA)){
		  ...
		  $resultado = $totalmeP * $linha['metragem'];
			...
			echo("		  
					  <br>Ref: ".$linha['ref']."</td>
      				<td width=\"608\" class=\"style1\">".$linha['titulo']."<br><br>".$linha['descricao']."</td>
			   </tr>
			   <tr>
	  				<td colspan=\"2\" class=\"style1\">&nbsp;</td>
    			</tr>
			   <tr>
    			...
    			<tr>
                  ...
                  <form name=\"form3\" id=\"form3\" method=\"post\" action=\"avaliacao_pdf.php\"><input type=\"submit\" value=\"Exportar para PDF\" name=\"exportar\" id=\"exportar\" class=\"campo3\" onClick=\"form3.action='avaliacao_pdf.php?codi_imo=".$codi_imo."&pastai=".$pastai."&totalme=".$totalme."&totalmeP=".$totalmeP."';\"></form>
	  				</span></div></td>
    			</tr>
			");		
