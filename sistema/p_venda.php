	...
	else
	{
		...
		for ($p = 1; $p <= $_POST['qtd_parc']; $p++) {
		  ...
		  if($dia_parc{$p}==''){
			   ...
			   $msg .= "
			   		<tr>
					   <td colspan=4 align=center class=style1>Preencha o campo Dia da Data Venda e clique no botão 'Atualizar Valores'!</td>
				   </tr>
			   ";
		  }
		  if($mes_parc{$p}==''){
			   ...
			   $msg .= "
			   		<tr>
					   <td colspan=4 align=center class=style1>Preencha o campo Mês da Data Venda e clique no botão 'Atualizar Valores'!</td>
				   </tr>
			   ";
		  }
		  if($ano_parc{$p}==''){
			  ...
			  $msg .= "
			   		<tr>
					   <td colspan=4 align=center class=style1>Preencha o campo Ano da Data Venda e clique no botão 'Atualizar Valores'!</td>
				   </tr>
			   ";
		...
		for ($c = 1; $c <= $_POST['qtdparc']; $c++) {

		  $dia_parca{$c} = $_POST[dia_parca][$c];
		  $mes_parca{$c} = $_POST[mes_parca][$c];
		  $ano_parca{$c} = $_POST[ano_parca][$c];
		  $dia_parcv{$c} = $_POST[dia_parcv][$c];
		  $mes_parcv{$c} = $_POST[mes_parcv][$c];
		  $ano_parcv{$c} = $_POST[ano_parcv][$c];
		  $dia_parci{$c} = $_POST[dia_parci][$c];
		  $mes_parci{$c} = $_POST[mes_parci][$c];
		  $ano_parci{$c} = $_POST[ano_parci][$c];

		  if($dia_parca{$c}==''){
			   $env = 0;
			   $msg .= "
			   		<tr>
					   <td colspan=4 align=center class=style1>Preencha o campo Dia da Parcela ".$c." da Comissão do Angariador e clique no botão 'Atualizar Valores'!</td>
				   </tr>
			   ";
		  }
		  if($mes_parca{$c}==''){
		       ...
		       $msg .= "
			   		<tr>
					   <td colspan=4 align=center class=style1>Preencha o campo Mês da Parcela ".$c." da Comissão do Angariador e clique no botão 'Atualizar Valores'!</td>
				   </tr>
			   ";
		  }
		  if($ano_parca{$c}==''){
		       ...
		       $msg .= "
			   		<tr>
					   <td colspan=4 align=center class=style1>Preencha o campo Ano da Parcela ".$c." da Comissão do Angariador e clique no botão 'Atualizar Valores'!</td>
				   </tr>
			   ";
		   }
		   if($dia_parcv{$c}==''){
		       ...
		       $msg .= "
			   		<tr>
					   <td colspan=4 align=center class=style1>Preencha o campo Dia da Parcela ".$c." da Comissão do Vendedor e clique no botão 'Atualizar Valores'!</td>
				   </tr>
			   ";
		   }
		   if($mes_parcv{$c}==''){
		        ...
		        $msg .= "
			   		<tr>
					   <td colspan=4 align=center class=style1>Preencha o campo Mês da Parcela ".$c." da Comissão do Vendedor e clique no botão 'Atualizar Valores'!</td>
				   </tr>
			   ";
		   }
		   if($ano_parcv{$c}==''){
		        ...
		        $msg .= "
			   		<tr>
					   <td colspan=4 align=center class=style1>Preencha o campo Ano da Parcela ".$c." da Comissão do Vendedor e clique no botão 'Atualizar Valores'!</td>
				   </tr>
			   ";
		  }
		   if($indicadores <> '0'){
		  	if($dia_parci{$c}==''){
		        ...
		        $msg .= "
			   		<tr>
					   <td colspan=4 align=center class=style1>Preencha o campo Dia da Parcela ".$c." da Comissão do Indicador e clique no botão 'Atualizar Valores'!</td>
				   </tr>
			   ";
		  	}
		  	if($mes_parci{$c}==''){
		        ...
		        $msg .= "
			   		<tr>
					   <td colspan=4 align=center class=style1>Preencha o campo Mês da Parcela ".$c." da Comissão do Indicador e clique no botão 'Atualizar Valores'!</td>
				   </tr>
			   ";
		  	}
		  	if($ano_parci{$c}==''){
		        ...
		        $msg .= "
			   		<tr>
					   <td colspan=4 align=center class=style1>Preencha o campo Ano da Parcela ".$c." da Comissão do Indicador e clique no botão 'Atualizar Valores'!</td>
				   </tr>
			   ";
		  	}
		...
		if ($env == 1){
            ...
            #dados para atualizar tabela ATUALIZAR (faz a sincronização com os sites).
            $atualiza_c_i = $_SESSION['cod_imobiliaria'];
            $atualiza_c_u = $_SESSION['u_cod'];
            $atualiza_imo = $not1['cod'];
            $atualiza_ref = $not1['ref'];
            $atualiza_acao = "Atualizar Imóvel";
            $atualiza_data = date("Y-m-d");
            $atualiza_hora = date("H:i:s");
			}
         ...
         $queryB = "INSERT INTO atualizacoes (cod_imobiliaria, a_cod_user, a_imovel, a_ref, a_acao, a_data, a_hora) VALUES
            ('$atualiza_c_i','$atualiza_c_u','$atualiza_imo','$atualiza_ref','$atualiza_acao', '$atualiza_data','$atualiza_hora')";
         $resultB = mysql_query($queryB) or die("Erro 383 - " . mysql_error());
	...
	for ($j = 1; $j <= $qtd_parc; $j++) {
           ...
           $query90 = "insert into contas (cod_imobiliaria, co_cliente, co_cat, co_imovel, co_desc, co_tipo, co_data, co_status, co_valor, co_locacao, co_usuario, co_forma, co_data_status, co_fixar) values('".$_SESSION['cod_imobiliaria']."','".$proprietario[$i3-1]."', 'Pagar', '$cod', '$l_pagto', 'Venda', '$anop1-$mesp1-$diap1', 'pendente', '$valores', '$l_cod', '$u_cod', 'Depósito', '$anop1-$mesp1-$diap1', '$co_fixar')";
				...
				for ($j = 1; $j <= $qtdparc; $j++) {
					...
					//vendedor
					$queryV = "insert into contas (cod_imobiliaria, co_cliente, co_cat, co_imovel, co_desc, co_tipo, co_data, co_status, co_valor, co_locacao, co_usuario, co_forma, co_data_status, co_fixar, co_tipo_user) values('".$_SESSION['cod_imobiliaria']."','$u_cod', 'Pagar', '$cod', '$l_pagto', 'Venda', '$ano_parcv[$j]-$mes_parcv[$j]-$dia_parcv[$j]', 'pendente', '$parcv[$j]', '$l_cod', '$u_cod', 'Depósito', '$ano_parcv[$j]-$mes_parcv[$j]-$dia_parcv[$j]', '$co_fixar','V')";
					$resultV = mysql_query($queryV) or die("Não foi possível atualizar suas informações." . $queryV);

					//indicador
					if($indicador<>'0'){
						$queryI = "insert into contas (cod_imobiliaria, co_cliente, co_cat, co_imovel, co_desc, co_tipo, co_data, co_status, co_valor, co_locacao, co_usuario, co_forma, co_data_status, co_fixar,co_tipo_user) values('".$_SESSION['cod_imobiliaria']."','$indicador', 'Pagar', '$cod', '$l_pagto', 'Venda', '$ano_parci[$j]-$mes_parci[$j]-$dia_parci[$j]', 'pendente', '$parci[$j]', '$l_cod', '$u_cod', 'Depósito', '$ano_parci[$j]-$mes_parci[$j]-$dia_parci[$j]', '$co_fixar','I')";
						$resultI = mysql_query($queryI) or die("Não foi possível atualizar suas informações." . $queryI);
					}

					//angariador
					if($angariador<>'0'){
						$queryA = "insert into contas (cod_imobiliaria, co_cliente, co_cat, co_imovel, co_desc, co_tipo, co_data, co_status, co_valor, co_locacao, co_usuario, co_forma, co_data_status, co_fixar, co_tipo_user) values('".$_SESSION['cod_imobiliaria']."','$angariador', 'Pagar', '$cod', '$l_pagto', 'Venda', '$ano_parca[$j]-$mes_parca[$j]-$dia_parca[$j]', 'pendente', '$parca[$j]', '$l_cod', '$u_cod', 'Depósito', '$ano_parca[$j]-$mes_parca[$j]-$dia_parca[$j]', '$co_fixar','A')";
						$resultA = mysql_query($queryA) or die("Não foi possível atualizar suas informações." . $queryA);
					}
				}
