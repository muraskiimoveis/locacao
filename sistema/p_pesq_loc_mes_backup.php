...
<div align="center">
  ...
  <table width="700" border="0" cellpadding="1" cellspacing="1" bgcolor="#<?php print("$cor1"); ?>">
    <tr bgcolor="#<?php print("$cor1"); ?>">
      <td width="100%" colspan=2 class=style1><p align="center"><b>Imóveis p/ Locação Mensal</b><br>
...
Exemplo: 80000000 </td>
    ...
    <tr bgcolor="#EDEEEE">
	  ...
	  <select name="local" class="campo" onChange="form1.action='p_pesq_loc_mes.php';form1.acaob.value='1';form1.acaoci.value='1';form1.submit();">
       ...
       <?
 		if($_GET['acaoci']=='1'){
	        $bcidades = mysql_query("SELECT ci_cod, ci_nome FROM rebri_cidades WHERE ci_estado='".$_GET['im_estado']."' ORDER BY ci_nome ASC");
