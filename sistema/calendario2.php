...
<table bgcolor="#DCE0E4" border="0" align="center" cellpadding="0" cellspacing="1">
  <tr> 
    ...
    <td colspan="5" bgcolor="#DCE0E4"><div align="center"><font size="1" face="Arial"><?= $mesext." / ". $ano?></font></div></td>
    <td width="20">
    </td>
  </tr>
  <tr> 
...
<?
	if ($shownextprev) {
?>
    <td colspan="5" bgcolor="#DCE0E4"><div align="center"><font size="1" face="Arial"><a href="javascript:prevmes(<?=$prevmes?>,<?=$prevano?>);"><< Anterior</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:nextmes(<?=$nextmes?>,<?=$nextano?>);">Próximo >></a></font></div></td>
    <td width="20">
    </td>
<?
	}
?>
  ...
  <tr bgcolor="#ffffff"> 
    <td width="20">
      <div align="center"><font size="1" face="Arial">D</font></div>
    </td>
    <td width="20"><div align="center"><font size="1" face="Arial">S</font></div></td>
    <td width="20"><div align="center"><font size="1" face="Arial">T</font></div></td>
    <td width="20"><div align="center"><font size="1" face="Arial">Q</font></div></td>
    <td width="20"><div align="center"><font size="1" face="Arial">Q</font></div></td>
    <td width="20"><div align="center"><font size="1" face="Arial">S</font></div></td>
    <td width="20"><div align="center"><font size="1" face="Arial">S</font></div></td>
  </tr>
...
for($i = 2; $i < 33; $i++)
{
	...
	### se dia está locado
		...
		echo "<td bgcolor=#3AB8F3><div align=center><font size=1 face=Arial color=ffffff>".$dia."</font></div></td>";
		}
		}else{
	        //if($entrada1 != ""){
        	//echo "<td bgcolor=#96B5C9><div align=center><font size=1 face=Arial>".$dia."</font></div></td>";
	...
	### se dia não está locado, mas pode ser locado
		...
		echo "<td bgcolor=#7AF2EB><div align=center><font size=1 face=Arial>".$dia."</font></div></td>";
