...
<div align="center">
  ...
  <table border="0" cellspacing="1" width="800" bgcolor="#<?php print("$cor1"); ?>">
    ...
    <tr bgcolor="#<?php print("$cor6"); ?>">
      ...
      <input type="submit" value="Atualizar Data" class=campo name="B1"> OBS.: Deve ser clicado sempre que a data for alterada.</td>
    </tr>
    </form>
<?php
	$query1 = "select * from muraski where cod='$cod' and cod_imobiliaria='".$_SESSION['cod_imobiliaria']."'";
...
?></textarea></td>
    ...
    <tr bgcolor="#<?php print("$cor6"); ?>">
      ...
      <td width="80%" class=style1><input type="text" name="co_cliente" size="4" class="campo2" readonly> <input type="text" name="nome_cliente" size="40" class="campo" readonly>
      	<input type="button" value="Selecionar" class="campo" onClick="window.open('p_list_clientes.php', 'janela', 'height=500,width=730,scrollbars=yes,status=no,toolbar=no,menubar=no,location=no');">
        <br>Se o locatário não está cadastrado <a target="_blank" href="p_insert_clientes.php" class="style1">clique aqui</a>.</td>
    </tr>
	<tr bgcolor="#<?php print("$cor6"); ?>">
    ...
    <tr bgcolor="#<?php print("$cor1"); ?>">
      ...
      <input type="submit" value="Inserir Reserva" class=campo name="B1"></td>
    </tr>
  </table>
  </form>
<br>
