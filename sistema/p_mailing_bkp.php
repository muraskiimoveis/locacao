...
<?php
			...
			$sql = "SELECT c_cod, c_email, c_nome FROM clientes WHERE c_email!='' AND cod_imobiliaria='".$_SESSION['cod_imobiliaria']."' AND c_email LIKE '%@%' AND c_email NOT LIKE '% %' AND c_email NOT LIKE '%,%' ORDER BY c_cod LIMIT $inicio,$msg_num";
...
<input type="hidden" name="enviado" value="1">
  <table width="75%" border="0" align="center" cellpadding="1" cellspacing="1">
    ...
    <tr class="fundoTabela">
      ...
      <td width="80%" class="style1"><input type="text" name="nome_de" size="40" value="Muraski Imóveis" class="campo" readonly></td>
    </tr>
    <tr class="fundoTabela">
      <td width="20%" class="style1"><b>E-mail do remetente:</b></td>
      <td width="80%" class="style1"><input type="text" name="email_de" size="40" value="sistema@muraski.com" class="campo" readonly></td>
    </tr>
<?
if($_GET['anuncio']<>''){
