		...
		//VERIFICA SE EXISTE A IMAGEM
		  ...
		  $resultado = $totalmeP * $linha3['metragem'];
			...
			$html .= '	  
      				...
      				<td width="608" class="style1"><table><tr><td align="justify">'.strip_tags($linha3['titulo']).'<br><br>'.strip_tags($linha3['descricao']).'<br>Metragem: '.$linha3['metragem'].' m²</td></tr></table></td>
			   </tr>
			   <tr>
		...
		//VERIFICA SE EXISTE A IMAGEM
		  ...
		  $resultado = $totalmeP * $linha4['metragem'];
			...
			$html .= '		  
      				...
      				<td width="608" class="style1"><table><tr><td align="justify">'.strip_tags($linha4['titulo']).'<br><br>'.strip_tags($linha4['descricao']).'<br>Metragem: '.$linha4['metragem'].' m²</td></tr></table></td>
			   </tr>
			   <tr>
	  				<td colspan="2" class="style1">&nbsp;</td>
    			</tr>
...
<input type="hidden" name="pastai" id="pastai" value="<?=$pastai; ?>">
  <table width="750" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td colspan="2" class="style1"><div align="center"><b>Amostragem para Avalia&ccedil;&atilde;o </b><br /><? if($codi_imo==''){ ?><span class="style7"><b>Selecione um imóvel para avaliar ou preencha um novo para avaliar</b></span><? } ?>
      </div></td>
    </tr>
<? if($codi_imo==''){ ?>
    <tr>
      <td colspan="2" class="style1"><b>Imóvel:</b>
    ...
    <tr>
      <td colspan="2"><div align="center"><span class="style1">
        ...
        <input type="button" value="Avaliar" name="avaliar" id="avaliar" class="campo3" onClick="VerificaCampo();"><br>ou
      </span></div></td>
    </tr>
    <tr>
      <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td colspan="4"><div align="center" class="style1"><b>Novo Im&oacute;vel para essa avalia&ccedil;&atilde;o</b><br><span class="style7">Depois de preencher os campos clique no botão "Avaliar" localizado abaixo para avaliar o imóvel descrito abaixo</span></div></td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<input type="button" value="Avaliar" name="avaliar" id="avaliar" class="campo3" onClick="VerificaCampo2();"></td>
  </tr>
</table>	  
    ...
    <tr>
      <td colspan="2"><table width="100%" border="0" cellpadding="1" cellspacing="1">
				<tr>
          			...
          			<td width="15%" class="TdSubTitulo"><b>Valor</b></td>
          			<td width="11%" class="TdSubTitulo"><b>M&eacute;dia</b></td>
       			    <td width="15%" class="TdSubTitulo"><b>Ação</b></td>
				</tr>
       		    <?
       		    if($_POST['buscar']=='1'){
				   //REALIZA BUSCA DO DADOS DO IMOVEL E VALOR
      ...
      <td colspan="2"><table width="100%" border="0" cellpadding="1" cellspacing="1">
        ...
        <?
        	if($_POST['buscar']=='1'){
				  ...
				  //REALIZA BUSCA DO DADOS DO IMOVEL E VALOR	  	               
       		      $buscaP = mysql_query("SELECT m.cod, m.ref, m.titulo, m.metragem, m.valor, m.finalidade, a.total_diarias FROM muraski m INNER JOIN avaliados a ON (m.cod=a.cod_imovel) WHERE a.user='".$u_cod."' AND m.cod_imobiliaria='".$linhaIM['im_cod']."' ORDER BY m.titulo ASC");
				  $totalmP = 0;
				  $totalvP = 0;
				  $totalmeP = 0;
				  while($linha = mysql_fetch_array($buscaP)){
					 ...
					 $diariasP = $linha['total_diarias'];
					  ...
					  ');
						 ...
						 if (file_exists($pasta.$nome_foto1))
						{
						 ...
						 echo('</span></td>
				         <td width="36%"><span class="'.$cor.'">'.$refP.' - '.$tituloP.'</span></td>
			...
			echo("		  
			   ...
			   <tr>
    			...
    			<tr>
                  ...
                  <form name=\"form3\" id=\"form3\" method=\"post\" action=\"avaliacao_doc.php\"><input type=\"submit\" value=\"Exportar para DOC\" name=\"exportar\" id=\"exportar\" class=\"campo3\" onClick=\"form3.action='avaliacao_doc.php?pdf=1&co_imovel=".$co_imovel."&totalme=".$totalme."&totalmeP=".$totalmeP."';\"></form>
	  				</span></div></td>
    			</tr>
			");
   	 	}
    			...
    			<tr>
	  				<td colspan=\"2\"><div align=\"center\"><span class=\"style1\">
	    				<form name=\"form2\" id=\"form2\" method=\"post\" action=\"avaliacao_impressao.php\"><input type=\"button\" value=\"Visualizar\" name=\"visualizar\" id=\"visualizar\" class=\"campo3\" onClick=\"MM_openBrWindow('avaliacao_impressao.php?codi_imo=".$codi_imo."&pastai=".$pastai."&totalme=".$totalme."&totalmeP=".$totalmeP."','','scrollbars=yes,resizable=no,width=800,height=600')\" class=\"style1\"></form>
                  		<form name=\"form3\" id=\"form3\" method=\"post\" action=\"avaliacao_doc.php\"><input type=\"submit\" value=\"Exportar para DOC\" name=\"exportar\" id=\"exportar\" class=\"campo3\" onClick=\"form3.action='avaliacao_doc.php?pdf=1&codi_imo=".$codi_imo."&pastai=".$pastai."&totalme=".$totalme."&totalmeP=".$totalmeP."';\"></form>
	  				</span></div></td>
    			</tr>
			");		
    			...
    			<tr>
	  				<td colspan=\"2\"><div align=\"center\"><span class=\"style1\">
	    				<form name=\"form2\" id=\"form2\" method=\"post\" action=\"avaliacao_impressao.php\"><input type=\"button\" value=\"Visualizar\" name=\"visualizar\" id=\"visualizar\" class=\"campo3\" onClick=\"MM_openBrWindow('avaliacao_impressao.php?co_imovel=".$co_imovel."&totalme=".$totalme."&totalmeP=".$totalmeP."&refs=".$refs."&titulos=".$titulos."&descricaos=".$descricaos."&metragems=".$metragems."','','scrollbars=yes,resizable=no,width=800,height=600')\" class=\"style1\"></form>
                  		<form name=\"form3\" id=\"form3\" method=\"post\" action=\"avaliacao_doc.php\"><input type=\"submit\" value=\"Exportar para DOC\" name=\"exportar\" id=\"exportar\" class=\"campo3\" onClick=\"form3.action='avaliacao_doc.php?pdf=1&co_imovel=".$co_imovel."&totalme=".$totalme."&totalmeP=".$totalmeP."&refs=".$refs."&titulos=".$titulos."&descricaos=".$descricaos."&metragems=".$metragems."';\"></form>
	  				</span></div></td>
    			</tr>
			");
