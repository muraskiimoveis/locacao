...
function processReqChange()
{
    ...
    if (req.readyState == 4) {
        ...
        if (req.status == 200) {
            ...
            document.getElementById('cidades2').innerHTML = req.responseText;
        } else {
...
*/	
	    echo $_POST['im_cidade'];
	    echo $_POST['im_estado'];
?>    
    <tr bgcolor="#EDEEEE">
      <td width="33%" class="style1"><b>Cidade Mat.:</b></td>
      <td width="67%"><div id="cidades"><? if($_POST['im_estado']){ ?>
	    <select name="im_cidade" id="im_cidade" class="campo">
        <option value="0">Selecione</option>
	  <?
	  	$bcidades = mysql_query("SELECT ci_cod, ci_estado, ci_nome FROM rebri_cidades WHERE ci_estado = '".$_POST['im_estado']."' ORDER BY ci_nome ASC");
	  ...
	  ?></div>
	  <!--select name="cidade_mat" id="cidade_mat" class="campo">
...
?>
	 <tr bgcolor="#EDEEEE">
      ...
      <td width="67%"><div id="cidades2"></div><!--input type="hidden" name="acaob" id="acaob" value="0">
