...
<table width="900" height="50" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td>
      <p align="center">
<? if ($imob == "muraski") { ?>
<!--         <iframe name="xml" marginwidth="0" marginheight="0" src="http://www.muraski.com/ler_atualizacao.php" topmargin="0" leftmargin="0" scrolling="yes" width="900" frameborder="0" height="400"></iframe> -->
  <!--      <iframe name="xml" marginwidth="0" marginheight="0" src="http://187.1.139.50/muraski/ler_atualizacao.php" topmargin="0" leftmargin="0" scrolling="yes" width="900" frameborder="0" height="400"></iframe> -->

<? } else { ?>
         <iframe name="xml" marginwidth="0" marginheight="0" src="http://187.1.139.50/redebrasileira/sistema/ler_xml.php?cod_imobiliaria=<?=$cod_imobiliaria?>&nome_pasta=<?=$nome_pasta?>" topmargin="0" leftmargin="0" scrolling="yes" width="900" frameborder="0" height="400"></iframe>
<? } ?>
