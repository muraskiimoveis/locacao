...
<div align="center">
  <center>
  <form method="get" action="p_lista_relloc.php" name="form1" onSubmit="return valida();">
  <table width="75%" border="0" cellpadding="1" cellspacing="1">
    <tr height="50">
      <td width="100%" colspan=2 class="style1"><p align="center"><b>Relatórios de Locações</b><br>
 Preencha os campos do seu interesse e clique em pesquisar.</font></p></td>
    ...
    <tr>
      ...
      <input type="submit" value="Pesquisar" name="B1" class=campo3></font></td>
    </tr>
  </table>
  </form>
<?php
