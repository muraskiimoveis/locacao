...
<page style="font-size: 10pt">
	...
	<br>
	<table style="border: solid 1px #000000;"><tr><td style=" border-top: solid 4mm #000077;	border-right: solid 3mm #007700;	border-bottom: solid 2mm #770000;	border-left:	solid 1mm #007777;	padding: 2mm 4mm 6mm 8mm; width: 100mm; background: #FFDDDD">Coucou ! ceci est un border solid</td></tr></table>
	<br>
	<table style="border: solid 1px #000000;"><tr><td style=" border-top: dotted 4mm #000077;	border-right: dotted 3mm #007700;	border-bottom: dotted 2mm #770000;	border-left:	dotted 1mm #007777;	padding: 2mm 4mm 6mm 8mm; width: 100mm; background: #FFDDDD">Coucou ! ceci est un border dotted</td></tr></table>
	<br>
	<table style="border: solid 1px #000000;"><tr><td style=" border-top: dashed 4mm #000077;	border-right: dashed 3mm #007700;	border-bottom: dashed 2mm #770000;	border-left:	dashed 1mm #007777;	padding: 2mm 4mm 6mm 8mm; width: 100mm; background: #FFDDDD">Coucou ! ceci est un border dashed</td></tr></table>
	<br>
<?php $back = 'background-image: url(./res/off.png);  background-position: left top; background-repeat: repeat; '; ?>
	<table style="background: #FFAAAA; color: #000022; border: 3px solid #555555;">
		...
		<tr>
			...
			<td style="border: solid 1px #000000; text-align: center;	<?php echo $back; ?>vertical-align: middle; height: 20mm">Case B2</td>
			<td style="border: solid 1px #000000; text-align: right;	<?php echo $back; ?>vertical-align: bottom; ">Case B3</td>
		</tr>
	</table>
	<br>
	<table style="border: solid 2px #550000; background: #000022 url(../_fpdf/tutorial/logo.png) center center no-repeat; color: #FFFFFF;">
		<tr >
