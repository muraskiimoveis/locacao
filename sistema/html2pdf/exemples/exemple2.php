...
<page style="font-size: 10pt">
	...
	<table style="width: 50%;border: solid 3px #5544DD">
		<tr>
			...
			<td style="width: 40%; text-align: center;"><img src="../_fpdf/tutorial/logo.png" alt="" ><br><i>légende</i></td>
	...
	texte à la suite d'une image, <img src="../_fpdf/tutorial/logo.png" alt="" style="height: 10mm">
