...
$arquivo = "demonstrativo_".$data_hora.".doc";
...
//$html2 .= '<link href="style.css" rel="stylesheet" type="text/css" />';
...
$html2 .= '<table width="750" border="0" align="center" cellpadding="1" cellspacing="1">
	...
	if (file_exists($caminho_logo.$logo_imob))
	{
		...
		//$html2 .= '<img src="'.$caminho_logo.$logo_imob.'" border="0"></td>';
      ...
      $mes_s = "0".$mes_s; 
         ...
         $buscas = mysql_query("SELECT s.valor_servico, s.data_servico, s.nome_servico FROM locacao l LEFT JOIN servicos s ON (s.locacao=l.l_cod) WHERE s.locacao='".$l_cod."' AND s.situacao!='Atrasado' AND s.cod_imobiliaria='".$_SESSION['cod_imobiliaria']."' AND s.data_servico like '$ano-$mes-%'");
            ...
            $html2 .= '<tr>
          				...
          				<td width="21%" class="style1">-'.$debitol.'</td>
        			</tr>
				';
    ...
    <tr>
      <td colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="21%" class="style1" bgcolor="#EDEEEE"> '.number_format($total_servico, 2, ',', '.').'</td>
        </tr>
      </table></td>
    </tr>';
...
$html2 .= '<tr>
      <td colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td class="style1"><div align="center">'.number_format($saldo_anterior, 2, ',', '.').'</div></td>
          <td class="style1"><div align="center">'.number_format($total_credito, 2, ',', '.').'</div></td>
          <td class="style1"><div align="center">'.number_format($total_deb, 2, ',', '.').'</div></td>
          <td class="style1"><div align="center">'.number_format($total_liquido, 2, ',', '.').'</div></td>
          <td class="style1"><div align="center">'.number_format($valor_repassado, 2, ',', '.').'</div></td>
          <td class="style1"><div align="center">'.number_format($saldo_atual, 2, ',', '.').'</div></td>
        </tr>
      </table></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="21%" class="style1">'.$valor_af.'</td>
        </tr>
      </table></td>
    </tr>
    <tr>
      <td colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="21%" class="style1">'.$valor_aj.'</td>
        </tr>
      </table></td>
    </tr>
    <tr>
      <td colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="21%" class="style1">'.number_format($total_aluguel, 2, ',', '.').'</td>
        </tr>
      </table></td>
    </tr>';
...
/*
$data_hora2 = date("d_m_Y_H_i_s");
$arquivo2 = "demonstrativo_".$data_hora2.".pdf";
...
?>
      ...
      <td width="576" colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
		  ...
		  <span class="noprint">
		  <input type="button" value="Pesquisar" name="pesquisar" id="pesquisar" class="campo3 noprint" onClick="VerificaCampo();">
		  </span></td>
        </tr>
        <tr>
          <td class="style1"><b>CEP: </b><?=$cep ?></td>
    ...
    <tr>
      <td colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td class="style1"><div align="center"><? echo(number_format($total_deb, 2, ',', '.')); ?></div></td>
...
<div class=noprint>	
	<tr>
	  <td colspan="4"><div align="center"><span class="style1">
	    <input id=idPrint type="button" value="Imprimir" class="campo3" onClick="javascript:self.print()"> 
	    <input id=idPrint type="button" name="fechar"  class="campo3" value="Fechar Janela" Onclick="window.close();">	
	    <form name="form2" id="form2" method="post" action="demonstrativos.php"><input id=idPrint type="submit" value="Exportar para DOC" class="campo3" onClick="form2.action='demonstrativos.php?pdf=1&l_cod=<?php print($l_cod); ?>&buscar=<?php print($buscar); ?>&cmes=<?php print($cmes); ?>&cano=<?php print($cano); ?>';"></form> 
	  </span></div></td>
    </tr>
</div>
	</table>
