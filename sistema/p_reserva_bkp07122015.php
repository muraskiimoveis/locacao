...
while($registro = mysql_fetch_array($exec_busca_conta)){
            ...
            $demo2='Data de Entrada '.$dta_entrada_boleto.' à '.$dta_saida_boleto;
            ...
            $insere_nrdoc = "update contas set co_boleto = ".$nrdoc.", co_status = 'pendente' where co_cod = ".$registro['co_cod']." and co_locacao = ".$registro['co_locacao'];
			...
			$insere_boleto .= "values ('".$nome."','".$nrdoc."','".date("Y-m-d", mktime(0, 0, 0, $mes, $dia, $ano))."',".number_format($valor_boleto,2,".","").",'".$dias_prazo."','".$taxa_boleto."',";
