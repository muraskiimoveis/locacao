...
// Calculo de dias para contrato e renovação
...
function google(coord) {
   if (coord != 'inicio') {
      NewWindow('http://<? echo $ORIGEM; ?>/intranet/sistema/gera_mapa.php?ori=muraski&coord='+coord, 'janela', 750, 500, 'yes');
   } else {
      NewWindow('http://<? echo $ORIGEM; ?>/intranet/sistema/gera_mapa.php?ori=muraski&coord=inicio', 'janela', 750, 500, 'yes');
   }
}
...
?>
	...
	<tr class="fundoTabela">
		<td width="35%" class=style1><b>Renovação Automatica.? &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b>  
...
?>
        <input name="renova_nao" id="renova_nao" type="radio" value="0" <? if($renova_simnao_new =='0'){ echo "CHECKED"; }  ?> OnClick="alert('Usuario Não Autorizado!!');">
			[ N&atilde;o ]
<?php
			} 
?>
...
<?php
			...
			echo "<script> javascript:alert(\"Faltam informações para Renovação Automática !!\"); </script>";
?>
...
?>
   ...
   <tr class="fundoTabela">
      <td class=style1><b>Situação da Venda : </b></td>
      <td class="style1">
        <input name="opcao_sem" id="opcao_sem" type="radio" value="0" <? if($not2[opcao_simnao]=='0'){ echo "CHECKED"; } ?> OnClick="seleciona_opcao_sem()">
        SEM Op&ccedil;&atilde;o assinada
        <input name="opcao_com" id="opcao_com" type="radio" value="1" <? if($not2[opcao_simnao]=='1'){ echo "CHECKED"; } ?> OnClick="seleciona_opcao_com()">
