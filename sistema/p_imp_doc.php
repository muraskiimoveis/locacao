...
$html10 .='<page><table border="0" cellspacing="1" width="800">
	...
	$html10 .='</td>
			...
			<tr>
  			...
  			<tr>
			  <td colspan="2" style="font-family: Verdana,Arial, Helvetica, sans-serif;font-size: 8px;color: #000000;text-align:center;"><b>'.$not3[d_nome].'</b></td>
			</tr>
			<tr>
			  <td colspan="2">&nbsp;</td>
			</tr>';

$estilo = 'style="font-family: Verdana,Arial, Helvetica, sans-serif;font-size: 8px;color: #000000;text-align:justify;"';
...
$html10 .='<tr>
			<td colspan="2" style="font-family: Verdana,Arial, Helvetica, sans-serif;font-size: 8px;color: #000000;text-align:left;"><b> '.$_SESSION['cidadei'].' - '.$_SESSION['estadoi'].', '.$dia2.'/'.$mes2.'/'.$ano2.'</b></td>
		</tr>
		<tr>
    		<td width="50" style="background:#EDEEEE;font-family: Verdana,Arial, Helvetica, sans-serif;font-size: 8px;color: #000000;"><br><br><b>PROPRIETÁRIO(A): <br>
      			_________________________</b></td>
    		<td width="50" style="background:#EDEEEE;font-family: Verdana,Arial, Helvetica, sans-serif;font-size: 8px;color: #000000;"><br><br><b>CORRETOR(A):<br> 
      			_________________________</b></td>
    	</tr>
<?php
  if(isset($c_conjuge)){
?>
		<tr>
    		<td width="50" style="background:#EDEEEE;font-family: Verdana,Arial, Helvetica, sans-serif;font-size: 8px;color: #000000;"><br><br><b>CONJUGE PROPRIETÁRIO(A): <br>
      			_________________________</b></td>
    		<td width="50" style="background:#EDEEEE;font-family: Verdana,Arial, Helvetica, sans-serif;font-size: 8px;color: #000000;"><br><br><b><br></b></td>
    	</tr>
<?php
}
?>
  		<tr>
    		<td width="50" style="background:#EDEEEE;font-family: Verdana,Arial, Helvetica, sans-serif;font-size: 8px;color: #000000;"><br><br><b>TESTEMUNHA:<br> 
      			_________________________</b></td>
    		<td width="50" style="background:#EDEEEE;font-family: Verdana,Arial, Helvetica, sans-serif;font-size: 8px;color: #000000;"><br><br><b>TESTEMUNHA: <br>
      			_________________________</b></td>
    	</tr>
    		<tr>
	  <td colspan="2" style="font-family: Verdana,Arial, Helvetica, sans-serif;font-size: 8px;color: #666666;text-align:center;">Rede Brasileira de Imóveis<BR />
         www.redebrasileiradeimoveis.com.br
	  </td>
    </tr>
  </table></page>';
...
$html10 .='<page><table border="0" cellspacing="1" width="800">
	...
	$html10 .='</td>
			...
			<tr>
  			...
  			<tr>
			  <td style="font-family: Verdana,Arial, Helvetica, sans-serif;font-size: 8px;color: #000000;text-align:center;"><b>'.$not3[d_nome].'</b></td>
			</tr>
			<tr>
			  <td>';
...
$html10 .='	<tr>
		...
		<tr>
	  <td  style="font-family: Verdana,Arial, Helvetica, sans-serif;font-size: 8px;color: #000000;text-align:center;">Rede Brasileira de Imóveis<BR />
         www.redebrasileiradeimoveis.com.br
	  </td>
    </tr>
...
$html10 .='<tr>
		 ...
		 <tr>
    		<td width="50" colspan="2" style="background:#EDEEEE;font-family: Verdana,Arial, Helvetica, sans-serif;font-size: 8px;color: #000000;"><br><br>PROPONENTE COMPRADOR(A):<br> 
      		_________________________</b></td>
    	</tr>
  		<tr>
    		<td width="50" style="background:#EDEEEE;font-family: Verdana,Arial, Helvetica, sans-serif;font-size: 8px;color: #000000;"><br><br><b>PROPRIETÁRIO(A): <br>
	...
	*/
	...
	// Somando 1 ao dia da saida;
    $data_mais1 = mktime(0, 0, 0, $mes1, $dia1+1, $ano1);
	$data_sai1=date("d-m-Y", $data_mais1);
    ...
    // Data de saida mais 1.
	$d_txt = str_replace("-data_sai1-", "<b>$data_sai1</b>", $d_txt);
...
$html10 .='<tr>
		...
		<tr>
    		<td width="50" style="background:#EDEEEE;font-family: Verdana,Arial, Helvetica, sans-serif;font-size: 8px;color: #000000;"><br><br><b>LOCATÁRIO: <br>
      			_________________________</b></td>
    		<td width="50" style="background:#EDEEEE;font-family: Verdana,Arial, Helvetica, sans-serif;font-size: 8px;color: #000000;"><br><br><b>LOCADOR:<br> 
      			_________________________</b></td>
    	</tr>
  		<tr>
    		<td width="50" style="background:#EDEEEE;font-family: Verdana,Arial, Helvetica, sans-serif;font-size: 8px;color: #000000;"><br><br><b>TESTEMUNHA:<br> 
	  	...
	  	<tr>
    		<td width="50" colspan="2" style="background:#EDEEEE;font-family: Verdana,Arial, Helvetica, sans-serif;font-size: 8px;color: #000000;"><br><br>Usuário (uso interno): '; 
...
$html10 .='<tr>
		...
		<tr>
    		<td width="50" style="background:#EDEEEE;font-family: Verdana,Arial, Helvetica, sans-serif;font-size: 8px;color: #000000;"><br><br><b>LOCATÁRIO(A):<br>
      		_________________________</b></td>
    		<td width="50" style="background:#EDEEEE;font-family: Verdana,Arial, Helvetica, sans-serif;font-size: 8px;color: #000000;"><br><br><b>LOCADOR(A): <br>
      		_________________________</b></td>
    	</tr>
  		<tr>
    		<td width="50" style="background:#EDEEEE;font-family: Verdana,Arial, Helvetica, sans-serif;font-size: 8px;color: #000000;"><br><br><b>TESTEMUNHA 1: <br>
      		_________________________</b></td>
    		<td width="50" style="background:#EDEEEE;font-family: Verdana,Arial, Helvetica, sans-serif;font-size: 8px;color: #000000;"><br><br><b>TESTEMUNHA 2: <br>
      		_________________________</b></td>
    	</tr>';
	...
	$html10 .='
		<tr>
    		<td width="50" colspan="2" style="background:#EDEEEE;font-family: Verdana,Arial, Helvetica, sans-serif;font-size: 8px;color: #000000;"><br>';
...
$html10 .='<tr>
	...
	$html10 .='
    	...
    	$html10 .='</td></tr>
	  	<tr>
    		<td width="50" colspan="2" style="font-family: Verdana,Arial, Helvetica, sans-serif;font-size: 8px;color: #000000;"><br><br>Usuário (uso interno): ';
...
<!--  		<td colspan=2 class="style"> -->
  		<td colspan=2 style="font-family:Verdana,Arial,Helvetica,sans-serif;font-size:10px;color:#000000;">
<!--			<p align="left"><textarea rows="15" name="txt" cols="100" class="campo"><?php print("$d_txt"); ?></textarea> -->
			<p align="left"><textarea rows="15" name="txt" cols="100" style="font-size: 10px; background-color: #ffffff; border: 1px solid #000000; border-color: #000000"><?php print("$d_txt"); ?></textarea>
...
<form method="post" action="<?php print("$url"); ?>">
	...
	<input type="hidden" name="imp" value="5">
  	<tr>
  		<td colspan=2 class="style">
			<p align="left"><textarea rows="15" name="txt" cols="100" class="campo"><?php print("$d_txt"); ?></textarea>
<!--			<p align="left"><textarea rows="15" name="txt" cols="100" style="font-size: 8px; background-color: #ffffff; border: 1px solid #000000; border-color: #000000"><?php print("$d_txt"); ?></textarea> -->
...
<form method="post" action="<?php print("$url"); ?>">
	...
	<input type="hidden" name="imp" value="9">
  	<tr>
<!--  		<td colspan=2 class="style"> -->
  		<td colspan=2 style="font-family:Verdana,Arial,Helvetica,sans-serif;font-size:8px;color:#000000;">
