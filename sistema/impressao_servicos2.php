...
$arquivo = "servicos_".$data_hora.".doc";
...
<div class=noprint>	
	<tr>
	  <td colspan="2"><div align="center"><span class="style1">
		...
		<form name="form3" id="form3" method="post" class="noprint" action=""><input type="submit" value="Exportar para DOC" name="exportar" id="exportar" class="campo3 noprint" onClick="form3.action='impressao_servicos.php?pdf=1&cod=<?=$cod ?>&l_cod=<?=$l_cod ?>';"></form>
	  </span></div></td>
    </tr>
</div>
	</table>
