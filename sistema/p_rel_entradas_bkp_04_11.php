...
<?php
	...
	(l_data_ent BETWEEN '$ano_entrada-$mes_entrada-$dia_entrada' AND '$ano_entrada1-$mes_entrada1-$dia_entrada1') and cod_imobiliaria='".$_SESSION['cod_imobiliaria']."' and l_n_contrato='' order by l_data_ent
	limit $from, 30";
...
<td bgcolor="#<?php print("$fundo2"); ?>" class="style1" valign="top"><p align="left">
...
<?php
	...
	$query3 = "SELECT ref, left(titulo, 60), cod, c_nome, c_cod FROM muraski, clientes WHERE cod='$not1[l_imovel]' and muraski.cliente like '".$cod_cliente."' and '".$cod_cliente2."'=clientes.c_cod and muraski.cod_imobiliaria='".$_SESSION['cod_imobiliaria']."'";
...
<?php
	...
	*/  
?>
<?php// print("<b>Ref.: $not3[ref]</b> - $not3[1]"); ?>
<?php
	//}
?>
<?php
