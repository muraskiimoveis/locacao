...
<?php
	...
	where cod=l_imovel and c_cod=cliente and 
...
?>
<tr>
	<td colspan=7 class=style1 align="left"><b>Extrato de Depósitos</b></td>
</tr>
<tr>
...
<tr class="fundoTabela">
	<td colspan="7"><table width=100%>
		<tr>
			<td class=style7 align=center><b>Existe saldo anterior pendente: R$ <?php print("$total_credp_tela7"); ?></b> - <a href="#" onclick="NewWindow('p_extrato_depositos.php?locacao=<?php print("$locacao_ant"); ?>&tipo_pesq=Locação', 'janela1', 750, 500, 'yes');" class="style1">Visualizar</a></td>
		</tr>
	</table></td>
</tr>
<?php
...
<tr>
	<td colspan=7 bgcolor="#<?php print("$cor6"); ?>"><table width=100%>
		<tr>
			<td class=style7 align=center><b>Existe saldo anterior pendente: R$ <?php print("$total_cred_desp_tela"); ?></b> - <a href="#" onclick="NewWindow('p_extrato_depositos.php?locacao=<?php print("$locacao_ant"); ?>&tipo_pesq=Locação', 'janela2', 750, 500, 'yes');" class="style1">Visualizar</a></td>
		</tr>
	</table></td>
</tr>
<?php
...
<?php
	...
	from contas 
	where co_locacao='$co_locacao' and co_cliente='$c_cod' and cod_imobiliaria='".$_SESSION['cod_imobiliaria']."' and co_cat='Receber' 
...
<tr>
	<td colspan=7 bgcolor="#<?php print("$cor6"); ?>"><table width=100%>
		<tr>
			<td class=style7 align=center><b>Existe saldo anterior pendente: R$ <?php print("$total_debp_tela7"); ?></b> - <a href="#" onclick="NewWindow('p_extrato_depositos.php?locacao=<?php print("$locacao_ant"); ?>&tipo_pesq=Locação', 'janela3', 750, 500, 'yes');" class="style1">Visualizar</a></td>
		</tr>
	</table></td>
</tr>
<?php
...
<?php
	...
	and co_status='pendente') AS saldo 
	from contas where co_locacao='$co_locacao' and co_cliente='$c_cod' and cod_imobiliaria='".$_SESSION['cod_imobiliaria']."' and co_cat='Pagar' order by co_cat desc, co_cliente, co_data";
