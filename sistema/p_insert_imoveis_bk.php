...
if($B1 == "Inserir Imóvel")
	...
	, '$ftxt_18', '$ftxt_19', '$ftxt_20', '".$cliente."', '$comissao_prop', '$matricula', '$cidade_mat'
           ...
           if($_POST['cont']){
		     for($i = 1; $i <= $_POST['cont']; $i++){
			   ...
			   echo("
           			...
           			<input type=\"text\" name=\"nome_cliente_$i\" id=\"nome_cliente_$i\" size=\"60\" class=\"campo\" value='$nome_cliente' readonly>
           			<input type=\"button\" id=\"selecionar2\" name=\"selecionar2\" value=\"Selecionar\" class=\"campo3\" onClick=\"window.open('p_list_proprietario2.php?id=".$i."', 'janela', 'height=500,width=730,scrollbars=yes,status=no,toolbar=no,menubar=no,location=no');\"><br>
			   ");
			 }  
		   }
?>         
