...
if($B1 == "Apagar Texto")
	...
	$result4 = mysql_query($query4,$con) or die ("erro 72");
...
if($lista == "")
	...
	$result1 = mysql_query($query1,$con) or die ("erro 125");
?>
<div align="center">
  <center>
...
<?php
	...
	$result3 = mysql_query($query3,$con) or die ("erro 188");
...
<?php
	...
	where n_cod = '$n_cod'";
	$result2 = mysql_query($query2,$con) or die ("erro 250");
