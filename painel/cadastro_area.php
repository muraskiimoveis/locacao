...
if($_POST['cadastra']=='1')
{
		...
		$busca = mysql_query($SQL,$con) or die ("erro 98");
...
if($id){
	$alteracao = "SELECT * FROM area WHERE area_id='".$id."'";
    $sql = mysql_query($alteracao,$con) or die ("erro 120");
   ...
   <table width="750" border="0" align="center" cellpadding="1" cellspacing="1">
     ...
     <tr>
       <td colspan="2"><table width="100%" border="0" cellpadding="1" cellspacing="1">
           ...
           <?
            $busca2 = "SELECT area_id, area_nome, area_parametro FROM area ORDER BY area_nome ASC";
            $sql = mysql_query($busca2,$con) or die ("erro 220");
