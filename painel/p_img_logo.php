...
$caminho_fundo = "http://www.redebrasileiradeimoveis.com.br/imobiliarias/".$pasta."/institucional/fundo/";
$caminho_topo = "http://www.redebrasileiradeimoveis.com.br/imobiliarias/".$pasta."/institucional/logo/";
...
define("INCOMING", "http://www.redebrasileiradeimoveis.com.br/logos/");
...
else
{
     function retira_acentos( $name ) {
	    ...
	    if($status=='p'){
			...
			/* where to move the uploaded file(s) to? */
			define("INCOMING2", "http://www.redebrasileiradeimoveis.com.br/logos_peq/");
			...
			/* where to move the uploaded file(s) to? */
			define("INCOMING3", "http://www.redebrasileiradeimoveis.com.br/logos_med/");
