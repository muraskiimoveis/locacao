...
function VerificaCampo() {
   ...
   if (document.formulario.im_razao.value=="") {
      msg += "Por favor, preencha a Razão Social.\n";
   }
   ...
   if (document.formulario.contrato_locacao.selectedIndex == 0) {
      msg += "Por favor, selecione o campo Contrato para Locação Temporada.\n";
   }
   
   if (document.formulario.contrato_locacao_anual.selectedIndex == 0) {
      msg += "Por favor, selecione o campo Contrato para Locação Anual.\n";
   }
...
if ($B1 == "Cadastrar") {
   ...
   if ($pw_rows == 0) {
      ...
      if($numrows == 0){
         ...
         if (file_exists("http://www.redebrasileiradeimoveis.com.br/imobiliarias/" . $nome_pasta)) {
            $cont = 1; // contador de pastas

            // verifica qual a ultima pasta criada e incrementa 1
            while (file_exists("http://www.redebrasileiradeimoveis.com.br/imobiliarias/" . $nome_pasta . $cont)) {
               $cont++;
            }
         ...
         // cria nova pasta
         $dirp = "http://www.redebrasileiradeimoveis.com.br/imobiliarias/".$nome_pasta;
         mkdir($dirp);
         chmod($dirp, 0777);

         $dirl = "http://www.redebrasileiradeimoveis.com.br/imobiliarias/".$nome_pasta."/locacao/";
         mkdir($dirl);
         chmod($dirl, 0777);

         $dirlp = "http://www.redebrasileiradeimoveis.com.br/imobiliarias/".$nome_pasta."/locacao_peq/";
         mkdir($dirlp);
         chmod($dirlp, 0777);

         $dirv = "http://www.redebrasileiradeimoveis.com.br/imobiliarias/".$nome_pasta."/venda/";
         mkdir($dirv);
         chmod($dirv, 0777);

         $dirvp = "http://www.redebrasileiradeimoveis.com.br/imobiliarias/".$nome_pasta."/venda_peq/";
         mkdir($dirvp);
         chmod($dirvp, 0777);

         $dirvv = "http://www.redebrasileiradeimoveis.com.br/imobiliarias/".$nome_pasta."/venda_vistoria/";
         mkdir($dirvv);
         chmod($dirvv, 0777);

         $dirvpv = "http://www.redebrasileiradeimoveis.com.br/imobiliarias/".$nome_pasta."/venda_vistoria_peq/";
         mkdir($dirvpv);
         chmod($dirvpv, 0777);

         $dirlv = "http://www.redebrasileiradeimoveis.com.br/imobiliarias/".$nome_pasta."/locacao_vistoria/";
         mkdir($dirlv);
         chmod($dirlv, 0777);

         $dirlpv = "http://www.redebrasileiradeimoveis.com.br/imobiliarias/".$nome_pasta."/locacao_vistoria_peq/";
         mkdir($dirlpv);
         chmod($dirlpv, 0777);

         $dirba = "http://www.redebrasileiradeimoveis.com.br/imobiliarias/".$nome_pasta."/banner_site/";
         mkdir($dirba);
         chmod($dirba, 0777);
	...
	if($end_igual2=='1'){
		$im_end_mapa2 = '';
         ...
         $query = "insert into rebri_imobiliarias (im_nome, im_contato, im_resp
            ...
            , im_cnpj, im_razao, im_banco, im_agencia, im_conta, im_tel, im_fax, im_cel
            ...
            , nome_pasta, contrato_venda, contrato_locacao, contrato_locacao_anual, im_tolera) values('$nome_imob'
            , '$im_contato', '$im_resp', '$im_creci_resp', '$im_nacionalidade'
            , '$im_est_civil', '$im_n_conselho', '$im_cnpj', '$im_razao', '$im_banco'
            ...
            , current_date, '$nome_pasta', '$contrato_venda', '$contrato_locacao', '$contrato_locacao_anual', '$im_tolera')";
...
function geraCodigoComputador() {
   ...
   do {
      ...
      $statement = mysql_query($SQL,$con) or die ("erro 562");
...
function geraCookie() {
   ...
   do {
      ...
      $statement = mysql_query($SQL,$con) or die ("erro 588");
   } while (mysql_num_rows($statement) == 1);
   return $_codigo;
}
...
// verifica se o formulário contém dados
 if (isset($envio) and $codigo == $random) {
   ...
   print $mensagem . "<br>";
	...
	$result4 = mysql_query($query4,$con) or die ("erro 675");
    ...
    $result = mysql_query($busca,$con) or die("Não foi possível apagar suas informações. $query");
    while($linha = mysql_fetch_array($result)){
         $pasta = $linha['nome_pasta'];
    }

	// apaga pasta locacao e imagens dentro
	$dirl = "http://www.redebrasileiradeimoveis.com.br/imobiliarias/".$pasta."/locacao/";
	...
	$dirlp = "http://www.redebrasileiradeimoveis.com.br/imobiliarias/".$pasta."/locacao_peq/";
	...
	$dirv = "http://www.redebrasileiradeimoveis.com.br/imobiliarias/".$pasta."/venda/";
   ...
   //apaga pasta venda peq e imagens dentro
	$dirvp = "http://www.redebrasileiradeimoveis.com.br/imobiliarias/".$pasta."/venda_peq/";
	...
	$dirvv = "http://www.redebrasileiradeimoveis.com.br/imobiliarias/".$pasta."/venda_vistoria/";
	...
	$dirvpv = "http://www.redebrasileiradeimoveis.com.br/imobiliarias/".$pasta."/venda_vistoria_peq/";
	...
	$dirlv = "http://www.redebrasileiradeimoveis.com.br/imobiliarias/".$pasta."/locacao_vistoria/";
	...
	$dirlpv = "http://www.redebrasileiradeimoveis.com.br/imobiliarias/".$pasta."/locacao_vistoria_peq/";
	...
	$dirba = "http://www.redebrasileiradeimoveis.com.br/imobiliarias/".$pasta."/banner_site/";
	...
	$dirp = "http://www.redebrasileiradeimoveis.com.br/imobiliarias/".$pasta;
	rmdir($dirp);
   ...
   for ($i = 0; $i < $qntd_tabelas; $i++) {
      ...
      $resultA8 = mysql_query($queryA8,$con) or die("Não foi possível apagar suas informações. $queryA8");
...
#   $im_site_institucional = addslashes($im_site_institucional);
	...
	//busca o nome da pasta
	$busca = "SELECT nome_pasta FROM rebri_imobiliarias WHERE im_cod='".$im_cod."'";
    $result = mysql_query($busca,$con) or die("Não foi possivel inserir suas informações");
    while($linha = mysql_fetch_array($result)){
         $pasta = $linha['nome_pasta'];
    }
	...
	// cria nova pasta
	$dirp = "http://www.redebrasileiradeimoveis.com.br/imobiliarias/".$nome_pasta;
	rename("http://www.redebrasileiradeimoveis.com.br/imobiliarias/".$pasta, $dirp);
	}
	...
	if ($nome_imob <> $_POST['im_nome']) {
		...
		$query = "UPDATE rebri_imobiliarias set im_nome='$nome_imob', im_contato='$im_contato'
         ...
         , im_est_civil='$im_est_civil', im_n_conselho='$im_n_conselho', im_cnpj='$im_cnpj', im_razao='$im_razao'
         ...
         , contrato_locacao='$contrato_locacao', contrato_locacao_anual='$contrato_locacao_anual', im_tolera='$im_tolera'
         where im_cod='$im_cod'";
      ...
      $query = "update rebri_imobiliarias set im_nome='$nome_imob', im_contato='$im_contato'
         ...
         , contrato_locacao_anual='$contrato_locacao_anual', im_tolera='$im_tolera'
...
if ($lista == "") {
	...
	order by i.im_nome
	limit $from, 30";
	$result1 = mysql_query($query1,$con) or die ("erro 1139");
...
<?php
	...
	$result2 = mysql_query($query2,$con) or die ("erro 1186");
...
################################################################################
	...
	$result2 = mysql_query($query2,$con) or die ("erro 1267");
	while($not2 = mysql_fetch_array($result2))
	{
...
function Atualiza(valor)
{
 ...
 <div align="center">
  ...
  <table border="0" cellspacing="1" width="850">
    ...
    <tr>
      <td width="20%" class=style2>Nome Fantasia:</td>
    ...
    <tr>
      <td width="27%" class=style2>Razão Social:</td>
      <td width="73%" class=style2> <input type="text" name="im_razao" size="40" class="campo" value="<?php if($_POST['im_razao']){ print($_POST['im_razao']); }else{ print($not2[im_razao]); } ?>"></td>
    </tr>
    <tr>
...
$sql = mysql_query($sql,$con) or die ("erro 1488");
...
?>
		...
		<?
    	if($_POST['im_estado']){
		  	$bestados = "SELECT e_cod, e_uf FROM rebri_estados ORDER BY e_uf ASC";
            $sql = mysql_query($bestados,$con) or die ("erro 1525");
		 	...
		 	$bestados = "SELECT e_cod, e_uf FROM rebri_estados ORDER BY e_uf ASC";
            $sql = mysql_query($bestados,$con) or die ("erro 1534");
 			while($linha = mysql_fetch_array($sql)){
    ...
    <tr>
	  ...
	  <?
   		if($_POST['im_cidade']){
	    	$bcidades = "SELECT ci_cod, ci_nome FROM rebri_cidades ORDER BY ci_nome ASC";
            $sql = mysql_query($bcidades,$con) or die ("erro 1556");
 	    	while($linha = mysql_fetch_array($sql)){
		  	...
		  	$bcidades = "SELECT ci_cod, ci_nome FROM rebri_cidades ORDER BY ci_nome ASC";
            $sql = mysql_query($bcidades,$con) or die ("erro 1566");
 	    	while($linha = mysql_fetch_array($sql)){
...
<?php
     $caminho_logo_gr = "http://www.redebrasileiradeimoveis.com.br/logos/";
...
<?php
	...
	$caminho_logo_med = "http://www.redebrasileiradeimoveis.com.br/logos_med/";
...
<?php
	...
	$caminho_logo_pq = "http://www.redebrasileiradeimoveis.com.br/logos_peq/";
...
?>
      ...
      <td width="80%" class=style2><select name="contrato_venda" id="contrato_venda" class="campo">
        ...
        <?php
		 if($_POST['contrato_venda']){ 
        	$documentosv = "select d_id, d_cod, d_nome FROM doc WHERE d_tipo_contrato='V' AND cod_imobiliaria='".$im_cod."' ORDER BY d_nome ASC";
            $sql = mysql_query($documentosv,$con) or die ("erro 1764");
 			while($linhav = mysql_fetch_array($sql)){
			...
			$documentosv = "select d_id, d_cod, d_nome FROM doc WHERE d_tipo_contrato='V' AND cod_imobiliaria='".$im_cod."' ORDER BY d_nome ASC";
            $sql = mysql_query($documentosv,$con) or die ("erro 1776");
 			while($linhav = mysql_fetch_array($sql)){
 		  	$d_nomev = substr ($linhav[d_nome], 0, 50);
			$id_venda = $linhav['d_id'];
    ...
    <tr>
      <td width="20%" class=style2 valign="top">Contrato para Loca&ccedil;&atilde;o Temporada: </td>
      <td width="80%" class=style2><select name="contrato_locacao" id="contrato_locacao" class="campo">
        <option value="">Selecione um contrato</option>
        <?php
		 if($_POST['contrato_locacao']){
        	$documentosl = "select d_id, d_cod, d_nome FROM doc WHERE d_tipo_contrato='L' AND d_cod!='10' AND d_cod!='11' AND cod_imobiliaria='".$im_cod."' ORDER BY d_nome ASC";
            $sql = mysql_query($documentosl,$con) or die ("erro 1797");
 			while($linhal = mysql_fetch_array($sql)){
        	...
        	$documentosl = "select d_id, d_cod, d_nome FROM doc WHERE d_tipo_contrato='L' AND d_cod!='10' AND d_cod!='11' AND cod_imobiliaria='".$im_cod."' ORDER BY d_nome ASC";
            $sql = mysql_query($documentosl,$con) or die ("erro 1809");
 			while($linhal = mysql_fetch_array($sql)){
 		  	$d_nomel = substr ($linhal[d_nome], 0, 50);
			$id_locacao = $linhal['d_id'];
    ...
    <tr>
      <td width="20%" class=style2 valign="top">Contrato para Loca&ccedil;&atilde;o Anual: </td>
      <td width="80%" class=style2><select name="contrato_locacao_anual" id="contrato_locacao_anual" class="campo">
        <option value="">Selecione um contrato</option>
        <?php
		 if($_POST['contrato_locacao_anual']){
        	$documentosla = "select d_id, d_cod, d_nome FROM doc WHERE d_tipo_contrato='L' AND (d_cod='10' OR d_cod='11') AND cod_imobiliaria='".$im_cod."' ORDER BY d_nome ASC";
            $sql = mysql_query($documentosla,$con) or die ("erro 1831");
 			while($linhala = mysql_fetch_array($sql)){
 		  	$d_nomela = substr ($linhala[d_nome], 0, 50);
			$id_locacaoa = $linhala['d_id'];
				if($linhala[d_cod]==$_POST['contrato_locacao_anual']){
					echo('<option value="'.$linhala[d_cod].'" title="'.$linhala[d_nome].'" SELECTED>'.$d_nomela.'...</option>');
				}else{
					echo('<option value="'.$linhala[d_cod].'" title="'.$linhala[d_nome].'">'.$d_nomela.'...</option>');
				}
 			}
		}else{
        	$documentosla = "select d_id, d_cod, d_nome FROM doc WHERE d_tipo_contrato='L' AND (d_cod='10' OR d_cod='11') AND cod_imobiliaria='".$im_cod."' ORDER BY d_nome ASC";
            $sql = mysql_query($documentosla,$con) or die ("erro 1843");
 			while($linhala = mysql_fetch_array($sql)){
 		  	$d_nomela = substr ($linhala[d_nome], 0, 50);
			$id_locacaoa = $linhala['d_id'];
				if($linhala[d_cod]==$not2['contrato_locacao_anual']){
					echo('<option value="'.$linhala[d_cod].'" title="'.$linhala[d_nome].'" SELECTED>'.$d_nomela.'...</option>');
				}else{
					echo('<option value="'.$linhala[d_cod].'" title="'.$linhala[d_nome].'">'.$d_nomela.'...</option>');
				}
    ...
    <tr>
      <td width="20%" class=style2>Tolerância de Horario :</td>
      <td width="80%" class=style2> <input type="text" name="im_tolera" id="im_tolera" size="8" class="campo" maxlength="8" onKeyUp="return autoTab(this, 8, event);" value="<?php if($_POST['im_tolera']){ print($_POST['im_tolera']); }else{ print($not2[im_tolera]); } ?>"></td>
    </tr>
	  <tr>
      <td colspan="5">
